...
async def demonstrate_new_patterns():
    ...
    try:
        ...
        async with KatanaClient(api_key="demo-key-for-testing") as client:
            ...
            print(f"✅ Manufacturing Order API available: {type(client.manufacturing_order).__name__}")
            ...
            print("   async def get_all_products(self, ids=None, name=None, limit=None, ...) -> ProductListResponse")
        ...
        print("🎯 All Union type issues eliminated - developers now have perfect ergonomics!")
