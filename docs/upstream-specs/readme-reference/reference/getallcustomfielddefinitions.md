        ...
        "parameters": [
          {
            "name": "label",
            "required": false,
            "description": "Filters by exact label match.",
            "schema": {
              "type": "string"
            },
            "in": "query"
          },
          {
            "name": "field_type",
            "required": false,
            "description": "Filters by field type.",
            "schema": {
              "type": "string",
              "enum": [
                "shortText",
              ...
              "application/json": {
                "example": {
                  "data": [
                    ...
                    {
                      "id": "7a214c83-9f10-46d2-bf52-5d8a4b1c0123",
                      "label": "Priority",
                      "description": "Numeric priority used for fulfillment ordering.",
                      "field_type": "number",
                      "entity_type": "SalesOrder",
                      "source": "your-integration",
                      "options": null,
