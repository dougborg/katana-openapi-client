---
updatedAt: 2026-07-15T08:31:11.000Z
---
...
Returns a list of manufacturing order production ingredients, sorted with the most recent first.
...
```json
{
  ...
  "paths": {
    "/manufacturing_order_production_ingredients": {
      "get": {
        "summary": "List all manufacturing order production ingredients",
        "tags": [
          "Manufacturing order production ingredient"
        ],
        "description": "Returns a list of manufacturing order production ingredients, sorted with the most recent first.",
        "operationId": "getAllManufacturingOrderProductionIngredients",
        "parameters": [
          {
            "name": "ids",
            "required": false,
            "description": "Filters production ingredients by an array of IDs",
            "schema": {
              "type": "array",
              "items": {
                "type": "integer"
          ...
          },
          {
            ...
            "required": false,
            "description": "Filters production ingredients by manufacturing order IDs",
            "schema": {
              "type": "array",
              "items": {
                "type": "integer"
          ...
          },
          {
            "name": "production_ids",
            "required": false,
            "description": "Filters production ingredients by production IDs",
            "schema": {
              "type": "array",
              "items": {
                "type": "integer"
        ...
        "responses": {
          "200": {
            "description": "List all manufacturing order production ingredients",
            "headers": {
              "X-Pagination": {
