...
- The first paragraph of the archived file is a forwarding note explaining when it was
  ...
  historical context.
- Links from the live tree to an archived path are broken on purpose — links should be
  updated to point at the new canonical doc, or removed if the reference is no longer
  relevant.
