...
**Summary:** Update a stock transfer **Description:** Updates the specified stock
transfer by setting the values of the parameters passed. Any parameters not provided
