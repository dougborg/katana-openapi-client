      ...
      "items": {
        ...
        "properties": {
          ...
          "batch_transactions": {
            "type": "array",
            "minItems": 1,
            "description": "Batch-level breakdown of the stock adjustment row quantity.
            The sum of batch transaction quantities must equal the row quantity.",
            "items": {
              "type": "object",
              "additionalProperties": false,
              "required": [
              ...
              "properties": {
                "batch_id": {
                  ...
                  "nullable": true,
                  "maximum": 2147483647,
                  "description": "ID of the batch to adjust stock for.
                  Use `null` to record unbatched (untraced) stock."
                },
                "quantity": {
                  "type": "number",
                  "maximum": 100000000000000000
