...
if TYPE_CHECKING:
    from ..models.clear_demand_forecast_request_periods_item import (
        ClearDemandForecastRequestPeriodsItem,
    )


T = TypeVar("T", bound="ClearDemandForecastRequest")


@_attrs_define
class ClearDemandForecastRequest:
    ...
    variant_id: int
    location_id: int
    periods: list[ClearDemandForecastRequestPeriodsItem]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        clear_demand_forecast_request = cls(
            variant_id=variant_id,
            location_id=location_id,
            periods=periods,
        )

        return clear_demand_forecast_request
