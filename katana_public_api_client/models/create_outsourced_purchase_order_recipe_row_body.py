...
if TYPE_CHECKING:
    from ..models.create_outsourced_purchase_order_recipe_row_body_batch_transactions_item import (
...
class CreateOutsourcedPurchaseOrderRecipeRowBody:
    ...
    batch_transactions: (
        list[CreateOutsourcedPurchaseOrderRecipeRowBodyBatchTransactionsItem] | Unset
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        batch_transactions: (
            list[CreateOutsourcedPurchaseOrderRecipeRowBodyBatchTransactionsItem]
            | Unset
        ) = UNSET
        if _batch_transactions is not UNSET:
            batch_transactions = []
            for batch_transactions_item_data in _batch_transactions:
                batch_transactions_item = CreateOutsourcedPurchaseOrderRecipeRowBodyBatchTransactionsItem.from_dict(
