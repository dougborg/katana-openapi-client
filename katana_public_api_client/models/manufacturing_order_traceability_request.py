...
T = TypeVar("T", bound="ManufacturingOrderTraceabilityRequest")


@_attrs_define
class ManufacturingOrderTraceabilityRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manufacturing_order_traceability_request = cls(
            batch_id=batch_id,
            serial_number_id=serial_number_id,
            quantity=quantity,
        )

        return manufacturing_order_traceability_request
