...
class SalesReturnApi:
    ...
    async def get_all_sales_returns(
        ...
        sales_order_id: Annotated[
            Optional[StrictInt], Field(description="Filter by original sales order ID")
        ] = None,
        status: Annotated[
            Optional[StrictStr], Field(description="Filter by return status")
        ] = None,
