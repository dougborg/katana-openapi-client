...
class SalesReturnApi:
    ...
    async def create_sales_return(
        self,
        create_sales_return_request: Annotated[
            CreateSalesReturnRequest, Field(..., description="Sales return details")
        ],
        **kwargs,
    ) -> SalesReturn:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_sales_return_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.create_sales_return_with_http_info(
            create_sales_return_request, **kwargs
        )

    @validate_arguments
    async def create_sales_return_with_http_info(
        self,
        create_sales_return_request: Annotated[
            CreateSalesReturnRequest, Field(..., description="Sales return details")
        ],
        **kwargs,
        ...
        _all_params = ["create_sales_return_request"]
        _all_params.extend(
            [
    ...
    async def get_all_sales_returns(
        ...
        sales_order_id: Annotated[
            StrictInt | None, Field(description="Filter by original sales order ID")
        ] = None,
        status: Annotated[
            StrictStr | None, Field(description="Filter by return status")
        ] = None,
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_sales_returns_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_all_sales_returns_with_http_info(
            limit,
            page,
            ids,
            customer_id,
    ...
    @validate_arguments
    async def get_all_sales_returns_with_http_info(
        self,
        limit: Annotated[
            StrictInt | None,
            Field(description="Number of records to return per page."),
    ...
    async def get_sales_return(
        self,
        id: Annotated[StrictInt, Field(..., description="Sales return ID")],
        **kwargs,
    ) -> SalesReturn:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_sales_return_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_sales_return_with_http_info(id, **kwargs)

    @validate_arguments
    async def get_sales_return_with_http_info(
        self,
        id: Annotated[StrictInt, Field(..., description="Sales return ID")],
        **kwargs,
    ) -> ApiResponse:
