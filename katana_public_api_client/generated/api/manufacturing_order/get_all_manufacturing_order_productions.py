...
from ...models.manufacturing_order_production_list_response import ManufacturingOrderProductionListResponse
...
) -> Optional[Union[ErrorResponse, ManufacturingOrderProductionListResponse]]:
    if response.status_code == 200:
        response_200 = ManufacturingOrderProductionListResponse.from_dict(response.json())
