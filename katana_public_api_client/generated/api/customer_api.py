...
class CustomerApi:
    ...
    @validate_arguments
    async def create_customer(self, create_customer_request : Annotated[CreateCustomerRequest, Field(..., description="New customer details")], **kwargs) -> Customer:  # noqa: E501
        ...
        return await self.create_customer_with_http_info(create_customer_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_customer_with_http_info(self, create_customer_request : Annotated[CreateCustomerRequest, Field(..., description="New customer details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a customer  # noqa: E501
    ...
    async def get_all_customers(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter by customer name")] = None, email : Annotated[Optional[StrictStr], Field(description="Filter by customer email")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> CustomerListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_customers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_customers_with_http_info(limit, page, ids, name, email, include_deleted, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_customers_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter by customer name")] = None, email : Annotated[Optional[StrictStr], Field(description="Filter by customer email")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all customers  # noqa: E501
