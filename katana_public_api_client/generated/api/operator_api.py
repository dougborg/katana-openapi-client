...
class OperatorApi:
    ...
    async def get_all_operators(
        ...
        working_area: Annotated[
            Optional[StrictStr],
            Field(description="Filters operators by their working area"),
        ] = None,
        resource_id: Annotated[
            Optional[StrictInt], Field(description="Filters operators by resource ID")
        ] = None,
        limit: Annotated[
            Optional[StrictInt],
        ...
        **kwargs,
        ...
        return await self.get_all_operators_with_http_info(
            working_area, resource_id, limit, page, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_all_operators_with_http_info(
        self,
        working_area: Annotated[
            Optional[StrictStr],
            Field(description="Filters operators by their working area"),
        ...
        **kwargs,
        ...
        _all_params = ["working_area", "resource_id", "limit", "page"]
        _all_params.extend(
            [
