...
class OperatorApi:
    ...
    async def get_all_operators(
        ...
        resource_id: Annotated[
            StrictInt | None, Field(description="Filters operators by resource ID")
        ] = None,
        limit: Annotated[
            StrictInt | None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_operators_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_operators_with_http_info(
        ...
        **kwargs,
        ...
        _query_params = []
        if _params.get("working_area") is not None:
