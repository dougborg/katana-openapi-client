...
class SalesOrdersApi:
    ...
    @validate_arguments
    async def create_sales_order_shipping_fee(self, create_sales_order_shipping_fee_request : Annotated[CreateSalesOrderShippingFeeRequest, Field(..., description="Shipping fee details")], **kwargs) -> SalesOrderShippingFee:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_sales_order_shipping_fee_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.create_sales_order_shipping_fee_with_http_info(create_sales_order_shipping_fee_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_sales_order_shipping_fee_with_http_info(self, create_sales_order_shipping_fee_request : Annotated[CreateSalesOrderShippingFeeRequest, Field(..., description="Shipping fee details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a sales order shipping fee  # noqa: E501
        ...
        _all_params = [
            'create_sales_order_shipping_fee_request'
        ]
        _all_params.extend(
            [
    ...
    @validate_arguments
    async def get_sales_order_accounting_metadata(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> SalesOrderAccountingMetadataListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_sales_order_accounting_metadata_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_sales_order_accounting_metadata_with_http_info(limit, page, ids, sales_order_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_sales_order_accounting_metadata_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List sales order accounting metadata  # noqa: E501
        ...
        return await self.api_client.call_api(
            '/sales_order_accounting_metadata', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def get_sales_order_shipping_fees(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> SalesOrderShippingFeeListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_sales_order_shipping_fees_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_sales_order_shipping_fees_with_http_info(limit, page, ids, sales_order_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_sales_order_shipping_fees_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List sales order shipping fees  # noqa: E501
