...
class PurchaseOrderAdditionalCostRowApi:
    ...
    @validate_arguments
    async def create_po_additional_cost_row(self, create_purchase_order_additional_cost_row_request : Annotated[CreatePurchaseOrderAdditionalCostRowRequest, Field(..., description="new purchase order additional cost row")], **kwargs) -> PurchaseOrderAdditionalCostRow:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_po_additional_cost_row_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.create_po_additional_cost_row_with_http_info(create_purchase_order_additional_cost_row_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_po_additional_cost_row_with_http_info(self, create_purchase_order_additional_cost_row_request : Annotated[CreatePurchaseOrderAdditionalCostRowRequest, Field(..., description="new purchase order additional cost row")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a purchase order additional cost row  # noqa: E501
        ...
        _all_params = [
            'create_purchase_order_additional_cost_row_request'
        ]
        _all_params.extend(
            [
    ...
    @validate_arguments
    async def delete_po_additional_cost(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost id")], **kwargs) -> None:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_po_additional_cost_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.delete_po_additional_cost_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    async def delete_po_additional_cost_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a purchase order additional cost row  # noqa: E501
        ...
        return await self.api_client.call_api(
            '/po_additional_cost_rows/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def get_po_additional_cost_row(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost row id")], **kwargs) -> PurchaseOrderAdditionalCostRow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_po_additional_cost_row_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_po_additional_cost_row_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_po_additional_cost_row_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost row id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a purchase order additional cost row  # noqa: E501
        ...
        return await self.api_client.call_api(
            '/po_additional_cost_rows/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def get_purchase_order_additional_cost_rows(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, group_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by group id")] = None, additional_cost_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by additional cost id")] = None, tax_rate_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by tax rate id")] = None, currency : Annotated[Optional[StrictStr], Field(description="Filters purchase orders by a currency")] = None, distribution_method : Annotated[Optional[StrictStr], Field(description="Filters purchase order additional cost rows by an distribution method")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> PurchaseOrderAdditionalCostRowListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_purchase_order_additional_cost_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_purchase_order_additional_cost_rows_with_http_info(ids, group_id, additional_cost_id, tax_rate_id, currency, distribution_method, include_deleted, limit, page, created_at_min, created_at_max, updated_at_min, updated_at_max, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_purchase_order_additional_cost_rows_with_http_info(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, group_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by group id")] = None, additional_cost_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by additional cost id")] = None, tax_rate_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters purchase order additional cost rows by tax rate id")] = None, currency : Annotated[Optional[StrictStr], Field(description="Filters purchase orders by a currency")] = None, distribution_method : Annotated[Optional[StrictStr], Field(description="Filters purchase order additional cost rows by an distribution method")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all purchase order additional cost rows  # noqa: E501
        ...
        if _params.get('additional_cost_id') is not None:  # noqa: E501
        ...
        if _params.get('distribution_method') is not None:  # noqa: E501
            _query_params.append(('distribution_method', _params['distribution_method']))
    ...
    @validate_arguments
    async def update_additional_cost_row(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost row id")], update_purchase_order_additional_cost_row_request : Annotated[UpdatePurchaseOrderAdditionalCostRowRequest, Field(..., description="Purchase order additional cost row details")], **kwargs) -> PurchaseOrderAdditionalCostRow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_additional_cost_row_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.update_additional_cost_row_with_http_info(id, update_purchase_order_additional_cost_row_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def update_additional_cost_row_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Purchase order additional cost row id")], update_purchase_order_additional_cost_row_request : Annotated[UpdatePurchaseOrderAdditionalCostRowRequest, Field(..., description="Purchase order additional cost row details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update a purchase order additional cost row  # noqa: E501
        ...
        _all_params = [
            'id',
            'update_purchase_order_additional_cost_row_request'
        ]
        _all_params.extend(
            [
                '_return_http_data_only',
        ...
        return await self.api_client.call_api(
            '/po_additional_cost_rows/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
