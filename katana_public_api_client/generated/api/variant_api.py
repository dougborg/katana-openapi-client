...
class VariantApi:
    ...
    async def get_all_variants(
        ...
        product_id: Annotated[
            Optional[StrictInt], Field(description="Filters variants by a product id")
        ] = None,
        material_id: Annotated[
            Optional[StrictInt], Field(description="Filters variants by a material id")
        ] = None,
        sku: Annotated[
        ...
        internal_barcode: Annotated[
            Optional[constr(strict=True, max_length=40, min_length=3)],
            Field(description="Filters variants by an internal barcode"),
        ] = None,
        registered_barcode: Annotated[
            Optional[constr(strict=True, max_length=120)],
