...
class VariantApi:
    ...
    async def create_variant(
        self,
        create_variant_request: Annotated[
            CreateVariantRequest, Field(..., description="new variant details")
        ],
        **kwargs,
    ) -> Variant:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_variant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.create_variant_with_http_info(
            create_variant_request, **kwargs
        )
    ...
    async def create_variant_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["create_variant_request"]
        _all_params.extend(
            [
    ...
    async def delete_variant(
        self, id: Annotated[StrictInt, Field(..., description="Variant id")], **kwargs
    ) -> None:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the delete_variant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.delete_variant_with_http_info(id, **kwargs)
    ...
    async def get_all_variants(
        ...
        product_id: Annotated[
            StrictInt | None, Field(description="Filters variants by a product id")
        ] = None,
        material_id: Annotated[
            StrictInt | None, Field(description="Filters variants by a material id")
        ] = None,
        sku: Annotated[
            conlist(StrictStr) | None,
            Field(description="Filters results by list of skus"),
        ] = None,
        sales_price: Annotated[
            StrictFloat | StrictInt | None,
            Field(description="Filters variants by a sales price"),
        ] = None,
        purchase_price: Annotated[
            StrictFloat | StrictInt | None,
            Field(description="Filters variants by a purchase price"),
        ] = None,
        internal_barcode: Annotated[
            constr(strict=True, max_length=40, min_length=3) | None,
            Field(description="Filters variants by an internal barcode"),
        ] = None,
        registered_barcode: Annotated[
            constr(strict=True, max_length=120) | None,
            Field(description="Filters variants by a registered barcode"),
        ] = None,
        supplier_item_codes: Annotated[
            conlist(constr(strict=True, min_length=1)) | None,
            Field(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_variants_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_all_variants_with_http_info(
            ids,
            product_id,
            material_id,
            sku,
    ...
    @validate_arguments
    async def get_all_variants_with_http_info(
        self,
        ids: Annotated[
            conlist(StrictInt) | None,
            Field(description="Filters results by an array of IDs."),
        ...
        **kwargs,
        ...
        if _params.get("product_id") is not None:
            _query_params.append(("product_id", _params["product_id"]))

        if _params.get("material_id") is not None:
        ...
        if _params.get("sales_price") is not None:
            _query_params.append(("sales_price", _params["sales_price"]))

        if _params.get("purchase_price") is not None:
            _query_params.append(("purchase_price", _params["purchase_price"]))

        if _params.get("internal_barcode") is not None:
            _query_params.append(("internal_barcode", _params["internal_barcode"]))

        if _params.get("registered_barcode") is not None:
            _query_params.append(("registered_barcode", _params["registered_barcode"]))

        if _params.get("supplier_item_codes") is not None:
            _query_params.append(
                ("supplier_item_codes", _params["supplier_item_codes"])
            )
    ...
    async def get_variant(
        self,
        id: Annotated[StrictInt, Field(..., description="Variant id")],
        extend: Annotated[
            conlist(StrictStr) | None,
            Field(description="Array of objects to extend the response."),
        ] = None,
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_variant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_variant_with_http_info(id, extend, **kwargs)

    @validate_arguments
    async def get_variant_with_http_info(
        self,
        id: Annotated[StrictInt, Field(..., description="Variant id")],
        extend: Annotated[
            conlist(StrictStr) | None,
    ...
    async def update_variant(
        self,
        id: Annotated[StrictInt, Field(..., description="Variant id")],
        update_variant_request: Annotated[
            UpdateVariantRequest, Field(..., description="Variant details")
        ],
        **kwargs,
    ) -> Variant:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_variant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_variant_with_http_info(
            id, update_variant_request, **kwargs
        )

    @validate_arguments
    async def update_variant_with_http_info(
        self,
        id: Annotated[StrictInt, Field(..., description="Variant id")],
        update_variant_request: Annotated[
            UpdateVariantRequest, Field(..., description="Variant details")
        ...
        **kwargs,
        ...
        _all_params = ["id", "update_variant_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
