...
class SalesOrderFulfillmentApi:
    ...
    async def get_all_sales_order_fulfillments(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> SalesOrderFulfillmentListResponse:  # noqa: E501
        ...
        return await self.get_all_sales_order_fulfillments_with_http_info(limit, page, sales_order_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_sales_order_fulfillments_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List sales order fulfillments  # noqa: E501
