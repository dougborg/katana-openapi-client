...
class VariantDefaultStorageBinApi:
    ...
    @validate_arguments
    async def link_variant_default_storage_bins(self, variant_default_storage_bin_link : Annotated[VariantDefaultStorageBinLink, Field(..., description="Linked variant default storage bin details")], **kwargs) -> VariantDefaultStorageBinLinkListResponse:  # noqa: E501
        ...
        return await self.link_variant_default_storage_bins_with_http_info(variant_default_storage_bin_link, **kwargs)  # noqa: E501

    @validate_arguments
    async def link_variant_default_storage_bins_with_http_info(self, variant_default_storage_bin_link : Annotated[VariantDefaultStorageBinLink, Field(..., description="Linked variant default storage bin details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Link variant default storage bins  # noqa: E501
        ...
        _all_params = [
            'variant_default_storage_bin_link'
        ]
        _all_params.extend(
            [
    ...
    @validate_arguments
    async def unlink_variant_default_storage_bins(self, unlink_variant_bin_location_request : Annotated[conlist(UnlinkVariantBinLocationRequest, max_items=150, min_items=1), Field(..., description="Unlinked variant default storage bin details")], **kwargs) -> None:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.unlink_variant_default_storage_bins_with_http_info(unlink_variant_bin_location_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def unlink_variant_default_storage_bins_with_http_info(self, unlink_variant_bin_location_request : Annotated[conlist(UnlinkVariantBinLocationRequest, max_items=150, min_items=1), Field(..., description="Unlinked variant default storage bin details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Unlink variant default storage bins  # noqa: E501
        ...
        _all_params = [
            'unlink_variant_bin_location_request'
        ]
        _all_params.extend(
            [
                '_return_http_data_only',
