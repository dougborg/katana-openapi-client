...
class VariantDefaultStorageBinApi:
    ...
    async def link_variant_default_storage_bins(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the link_variant_default_storage_bins_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def unlink_variant_default_storage_bins(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the unlink_variant_default_storage_bins_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
