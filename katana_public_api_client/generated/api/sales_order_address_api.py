...
class SalesOrderAddressApi:
    ...
    async def get_all_sales_order_addresses(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, entity_type : Annotated[Optional[StrictStr], Field(description="Filter by address type")] = None, **kwargs) -> SalesOrderAddressListResponse:  # noqa: E501
        ...
        return await self.get_all_sales_order_addresses_with_http_info(limit, page, sales_order_id, entity_type, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_sales_order_addresses_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, entity_type : Annotated[Optional[StrictStr], Field(description="Filter by address type")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List sales order addresses  # noqa: E501
