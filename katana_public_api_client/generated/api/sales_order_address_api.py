...
class SalesOrderAddressApi:
    ...
    @validate_arguments
    async def get_all_sales_order_addresses(
        self,
        limit: Annotated[
            Optional[StrictInt],
        ...
        sales_order_id: Annotated[
            Optional[StrictInt], Field(description="Filter by sales order ID")
        ] = None,
        entity_type: Annotated[
            Optional[StrictStr], Field(description="Filter by address type")
        ] = None,
        **kwargs,
    ) -> SalesOrderAddressListResponse:  # noqa: E501
        """List sales order addresses  # noqa: E501

        Returns a list of sales order addresses.  # noqa: E501
        ...
        :rtype: SalesOrderAddressListResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_sales_order_addresses_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_sales_order_addresses_with_http_info(
            limit, page, sales_order_id, entity_type, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_all_sales_order_addresses_with_http_info(
        self,
        limit: Annotated[
            Optional[StrictInt],
            Field(description="Number of records to return per page."),
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(SalesOrderAddressListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["limit", "page", "sales_order_id", "entity_type"]
        _all_params.extend(
            [
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_sales_order_addresses" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
