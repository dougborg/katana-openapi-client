    ...
    async def get_all_sales_order_addresses(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_sales_order_addresses_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
