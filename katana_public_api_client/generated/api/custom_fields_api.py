...
class CustomFieldsApi:
    ...
    @validate_arguments
    async def get_all_custom_fields_collections(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, **kwargs) -> CustomFieldsCollectionListResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_custom_fields_collections_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_custom_fields_collections_with_http_info(limit, page, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_custom_fields_collections_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all custom fields collections  # noqa: E501
