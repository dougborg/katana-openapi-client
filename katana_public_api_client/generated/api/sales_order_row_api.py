...
class SalesOrderRowApi:
    ...
    async def get_all_sales_order_rows(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filter by variant ID")] = None, **kwargs) -> SalesOrderRowListResponse:  # noqa: E501
        ...
        return await self.get_all_sales_order_rows_with_http_info(limit, page, sales_order_id, variant_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_sales_order_rows_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, sales_order_id : Annotated[Optional[StrictInt], Field(description="Filter by sales order ID")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filter by variant ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List sales order rows  # noqa: E501
