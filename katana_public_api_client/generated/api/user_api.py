...
class UserApi:
    ...
    @validate_arguments
    async def get_all_users(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, role : Annotated[Optional[StrictStr], Field(description="Filter by user role")] = None, status : Annotated[Optional[StrictStr], Field(description="Filter by user status")] = None, **kwargs) -> UserListResponse:  # noqa: E501
        ...
        return await self.get_all_users_with_http_info(limit, page, role, status, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_users_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, role : Annotated[Optional[StrictStr], Field(description="Filter by user role")] = None, status : Annotated[Optional[StrictStr], Field(description="Filter by user status")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all users  # noqa: E501
