...
class UserApi:
    ...
    async def get_all_users(
        ...
        role: Annotated[
            StrictStr | None, Field(description="Filter by user role")
        ] = None,
        status: Annotated[
            StrictStr | None, Field(description="Filter by user status")
        ] = None,
        **kwargs,
    ) -> UserListResponse:
        """List all users  # noqa: E501

        Returns a list of active users in your account.  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_users_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_all_users_with_http_info(
            limit, page, role, status, **kwargs
        )
    ...
    async def get_all_users_with_http_info(
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(UserListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["limit", "page", "role", "status"]
        _all_params.extend(
            [
        ...
        if _params.get("role") is not None:
