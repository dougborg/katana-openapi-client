...
class StockTransferApi:
    ...
    @validate_arguments
    async def get_all_stock_transfers(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, from_location_id : Annotated[Optional[StrictInt], Field(description="Filter by source location ID")] = None, to_location_id : Annotated[Optional[StrictInt], Field(description="Filter by destination location ID")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> StockTransferListResponse:  # noqa: E501
        ...
        return await self.get_all_stock_transfers_with_http_info(limit, page, ids, from_location_id, to_location_id, include_deleted, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_stock_transfers_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, from_location_id : Annotated[Optional[StrictInt], Field(description="Filter by source location ID")] = None, to_location_id : Annotated[Optional[StrictInt], Field(description="Filter by destination location ID")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all stock transfers  # noqa: E501
