...
class StockTransferApi:
    ...
    async def get_all_stock_transfers(
        ...
        from_location_id: Annotated[
            StrictInt | None, Field(description="Filter by source location ID")
        ] = None,
        to_location_id: Annotated[
            StrictInt | None, Field(description="Filter by destination location ID")
        ] = None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_stock_transfers_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_stock_transfers_with_http_info(
        ...
        **kwargs,
        ...
        if _params.get("from_location_id") is not None:
            _query_params.append(("from_location_id", _params["from_location_id"]))

        if _params.get("to_location_id") is not None:
