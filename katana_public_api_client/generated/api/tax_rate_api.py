...
class TaxRateApi:
    ...
    @validate_arguments
    async def create_tax_rate(self, create_tax_rate_request : Annotated[CreateTaxRateRequest, Field(..., description="new tax rate details")], **kwargs) -> TaxRate:  # noqa: E501
        ...
        return await self.create_tax_rate_with_http_info(create_tax_rate_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_tax_rate_with_http_info(self, create_tax_rate_request : Annotated[CreateTaxRateRequest, Field(..., description="new tax rate details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a tax rate  # noqa: E501
    ...
    @validate_arguments
    async def get_all_tax_rates(self, rate : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters tax rates by rate")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filters additional costs by a name")] = None, is_default_sales : Annotated[Optional[StrictBool], Field(description="Filters tax rates by an is_default_sales")] = None, is_default_purchases : Annotated[Optional[StrictBool], Field(description="Filters tax rates by an is_default_purchases")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> TaxRateListResponse:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            ...
            raise ValueError(message)
        return await self.get_all_tax_rates_with_http_info(rate, ids, name, is_default_sales, is_default_purchases, limit, page, created_at_min, created_at_max, updated_at_min, updated_at_max, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_tax_rates_with_http_info(self, rate : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters tax rates by rate")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filters additional costs by a name")] = None, is_default_sales : Annotated[Optional[StrictBool], Field(description="Filters tax rates by an is_default_sales")] = None, is_default_purchases : Annotated[Optional[StrictBool], Field(description="Filters tax rates by an is_default_purchases")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all tax rates  # noqa: E501
        ...
        if _params.get('is_default_purchases') is not None:  # noqa: E501
            _query_params.append(('is_default_purchases', _params['is_default_purchases']))
