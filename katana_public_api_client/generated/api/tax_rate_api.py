...
class TaxRateApi:
    ...
    async def create_tax_rate(
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_tax_rate_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_tax_rates(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_tax_rates_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
    ...
    async def get_all_tax_rates_with_http_info(
        ...
        **kwargs,
        ...
        # process the query parameters
        _query_params = []
        if _params.get("rate") is not None:
        ...
        if _params.get("is_default_sales") is not None:
            _query_params.append(("is_default_sales", _params["is_default_sales"]))

        if _params.get("is_default_purchases") is not None:
