...
class StocktakeRowApi:
    ...
    async def get_all_stocktake_rows(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, stocktake_id : Annotated[Optional[StrictInt], Field(description="Filter by stocktake ID")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filter by variant ID")] = None, **kwargs) -> StocktakeRowListResponse:  # noqa: E501
        ...
        return await self.get_all_stocktake_rows_with_http_info(limit, page, stocktake_id, variant_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_stocktake_rows_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, stocktake_id : Annotated[Optional[StrictInt], Field(description="Filter by stocktake ID")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filter by variant ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List stocktake rows  # noqa: E501
