...
class StocktakeRowApi:
    ...
    async def get_all_stocktake_rows(
        ...
        stocktake_id: Annotated[
            StrictInt | None, Field(description="Filter by stocktake ID")
        ] = None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_stocktake_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_stocktake_rows_with_http_info(
        ...
        **kwargs,
        ...
        if _params.get("stocktake_id") is not None:
