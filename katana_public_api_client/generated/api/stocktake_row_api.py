...
class StocktakeRowApi:
    ...
    @validate_arguments
    async def get_all_stocktake_rows(
        self,
        limit: Annotated[
            Optional[StrictInt],
        ...
        stocktake_id: Annotated[
            Optional[StrictInt], Field(description="Filter by stocktake ID")
        ] = None,
        variant_id: Annotated[
            Optional[StrictInt], Field(description="Filter by variant ID")
        ] = None,
        **kwargs,
    ) -> StocktakeRowListResponse:  # noqa: E501
        """List stocktake rows  # noqa: E501

        Returns a list of stocktake rows.  # noqa: E501

        :param limit: Number of records to return per page.
        :type limit: int
        :param page: Page number to return.
        :type page: int
        :param stocktake_id: Filter by stocktake ID
        :type stocktake_id: int
        ...
        :rtype: StocktakeRowListResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_stocktake_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_stocktake_rows_with_http_info(
            limit, page, stocktake_id, variant_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_all_stocktake_rows_with_http_info(
        self,
        limit: Annotated[
            Optional[StrictInt],
            Field(description="Number of records to return per page."),
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(StocktakeRowListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["limit", "page", "stocktake_id", "variant_id"]
        _all_params.extend(
            [
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_stocktake_rows" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("stocktake_id") is not None:  # noqa: E501
            _query_params.append(("stocktake_id", _params["stocktake_id"]))
