...
class PriceListApi:
    ...
    @validate_arguments
    async def create_price_list(self, create_price_list_request : Annotated[CreatePriceListRequest, Field(..., description="Price list details")], **kwargs) -> PriceList:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_price_list_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.create_price_list_with_http_info(create_price_list_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_price_list_with_http_info(self, create_price_list_request : Annotated[CreatePriceListRequest, Field(..., description="Price list details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a price list  # noqa: E501
    ...
    @validate_arguments
    async def get_all_price_lists(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter by price list name")] = None, currency : Annotated[Optional[StrictStr], Field(description="Filter by currency")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> PriceListListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_price_lists_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_price_lists_with_http_info(limit, page, ids, name, currency, include_deleted, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_price_lists_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filter by price list name")] = None, currency : Annotated[Optional[StrictStr], Field(description="Filter by currency")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List price lists  # noqa: E501
