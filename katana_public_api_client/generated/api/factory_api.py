...
class FactoryApi:
    ...
    @validate_arguments
    async def get_factory(self, **kwargs) -> Factory:  # noqa: E501
        """Retrieve the current factory  # noqa: E501

        Returns the general information about the factory.  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_factory_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_factory_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    async def get_factory_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve the current factory  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Factory, status_code(int), headers(HTTPHeaderDict))
        """
