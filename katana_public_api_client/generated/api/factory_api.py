...
class FactoryApi:
    ...
    @validate_arguments
    async def get_factory(self, **kwargs) -> Factory:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_factory_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_factory_with_http_info(**kwargs)

    @validate_arguments
    async def get_factory_with_http_info(self, **kwargs) -> ApiResponse:
        """Retrieve the current factory  # noqa: E501
