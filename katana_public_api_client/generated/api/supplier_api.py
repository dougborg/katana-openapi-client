...
class SupplierApi:
    ...
    async def create_supplier(
        ...
        create_supplier_request: Annotated[
            CreateSupplierRequest, Field(..., description="new supplier details")
        ],
        **kwargs,
    ) -> Supplier:  # noqa: E501
        ...
        return await self.create_supplier_with_http_info(
            create_supplier_request, **kwargs
        )  # noqa: E501
    ...
    async def create_supplier_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["create_supplier_request"]
        _all_params.extend(
            [
    ...
    async def delete_supplier(
        self, id: Annotated[StrictInt, Field(..., description="Supplier id")], **kwargs
    ) -> None:  # noqa: E501
    ...
    @validate_arguments
    async def delete_supplier_with_http_info(
        self, id: Annotated[StrictInt, Field(..., description="Supplier id")], **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Delete a supplier  # noqa: E501
    ...
    async def get_all_suppliers(
        ...
        email: Annotated[
            Optional[StrictStr], Field(description="Filters suppliers by an email")
        ] = None,
        phone: Annotated[
            Optional[StrictStr],
            Field(description="Filters suppliers by a phone number"),
        ] = None,
        ...
        **kwargs,
    ) -> SupplierListResponse:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.get_all_suppliers_with_http_info(
            name,
            ids,
            email,
            phone,
    ...
    @validate_arguments
    async def get_all_suppliers_with_http_info(
        self,
        name: Annotated[
            Optional[StrictStr], Field(description="Filters additional costs by a name")
        ] = None,
    ...
    async def update_supplier(
        self,
        id: Annotated[StrictInt, Field(..., description="Supplier id")],
        update_supplier_request: Annotated[
            UpdateSupplierRequest, Field(..., description="Supplier details")
        ],
        **kwargs,
    ) -> Supplier:  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return await self.update_supplier_with_http_info(
            id, update_supplier_request, **kwargs
        )  # noqa: E501
    ...
    async def update_supplier_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["id", "update_supplier_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
