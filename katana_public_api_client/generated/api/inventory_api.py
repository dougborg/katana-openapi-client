...
class InventoryApi:
    ...
    async def create_inventory_safety_stock_level(
        ...
        **kwargs,
    ) -> InventorySafetyStockLevel:  # noqa: E501
    ...
    async def get_all_inventory_point(
        ...
        **kwargs,
    ) -> InventoryListResponse:  # noqa: E501
    ...
    async def get_all_negative_stock(
        ...
        sku: Annotated[
            Optional[StrictStr], Field(description="Filters results by a sku")
        ] = None,
        category: Annotated[
            Optional[StrictStr],
    ...
    async def get_inventory_reorder_points(
        ...
        **kwargs,
    ) -> InventoryReorderPointListResponse:  # noqa: E501
