...
class SalesReturnRowApi:
    ...
    async def get_all_sales_return_rows(
        ...
        sales_return_id: Annotated[
            StrictInt | None, Field(description="Filter by sales return ID")
        ] = None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_sales_return_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_sales_return_rows_with_http_info(
        ...
        **kwargs,
        ...
        if _params.get("sales_return_id") is not None:
