...
class StocktakeApi:
    ...
    async def get_all_stocktakes(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filter by location ID")] = None, status : Annotated[Optional[StrictStr], Field(description="Filter by status")] = None, **kwargs) -> StocktakeListResponse:  # noqa: E501
        ...
        return await self.get_all_stocktakes_with_http_info(limit, page, ids, location_id, status, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_stocktakes_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filter by location ID")] = None, status : Annotated[Optional[StrictStr], Field(description="Filter by status")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List stocktakes  # noqa: E501
