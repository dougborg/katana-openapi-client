...
class BatchApi:
    ...
    async def get_batch_stock(
        ...
        batch_barcode: Annotated[
            Optional[StrictStr], Field(description="Filter results by batch barcode.")
        ] = None,
        ...
        include_empty: Annotated[
            Optional[StrictBool], Field(description="Include empty result objects.")
        ] = None,
        limit: Annotated[
            Optional[StrictInt],
