...
class BatchApi:
    ...
    async def create_batch(
        self,
        batch: Annotated[Batch, Field(..., description="New batch values")],
        **kwargs,
    ) -> Batch:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_batch_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.create_batch_with_http_info(batch, **kwargs)

    @validate_arguments
    async def create_batch_with_http_info(
        self,
        batch: Annotated[Batch, Field(..., description="New batch values")],
        **kwargs,
    ) -> ApiResponse:
    ...
    async def get_batch_stock(
        ...
        batch_id: Annotated[
            StrictInt | None,
            Field(description="Filters results by a valid batch id."),
        ] = None,
        batch_number: Annotated[
            StrictStr | None,
            Field(description="Filters results by a valid batch number."),
        ] = None,
        ...
        batch_barcode: Annotated[
            StrictStr | None, Field(description="Filter results by batch barcode.")
        ] = None,
        batch_created_at_min: Annotated[
            StrictStr | None,
            Field(description="Minimum value for batch_created_at range (ISO 8601)."),
        ] = None,
        batch_created_at_max: Annotated[
            StrictStr | None,
            Field(description="Maximum value for batch_created_at range (ISO 8601)."),
        ] = None,
        include_empty: Annotated[
            StrictBool | None, Field(description="Include empty result objects.")
        ] = None,
        limit: Annotated[
            StrictInt | None,
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_batch_stock_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_batch_stock_with_http_info(
            batch_id,
            batch_number,
            location_id,
            variant_id,
    ...
    @validate_arguments
    async def get_batch_stock_with_http_info(
        self,
        batch_id: Annotated[
            StrictInt | None,
            Field(description="Filters results by a valid batch id."),
        ...
        **kwargs,
        ...
        # process the query parameters
        _query_params = []
        if _params.get("batch_id") is not None:
            _query_params.append(("batch_id", _params["batch_id"]))

        if _params.get("batch_number") is not None:
        ...
        if _params.get("batch_barcode") is not None:
            _query_params.append(("batch_barcode", _params["batch_barcode"]))

        if _params.get("batch_created_at_min") is not None:
            _query_params.append(
                ("batch_created_at_min", _params["batch_created_at_min"])
            )

        if _params.get("batch_created_at_max") is not None:
            _query_params.append(
                ("batch_created_at_max", _params["batch_created_at_max"])
            )

        if _params.get("include_empty") is not None:
    ...
    @validate_arguments
    async def update_batch_stock(
        self,
        batch_id: StrictInt,
        batch_stock_update: Annotated[
            BatchStockUpdate,
            Field(..., description="Batch stock fields to be updated with new values"),
        ],
        location_id: Annotated[
            StrictInt | None, Field(description="Filters results by a location ID.")
        ] = None,
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_batch_stock_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_batch_stock_with_http_info(
            batch_id, batch_stock_update, location_id, **kwargs
        )

    @validate_arguments
    async def update_batch_stock_with_http_info(
        self,
        batch_id: StrictInt,
        batch_stock_update: Annotated[
            BatchStockUpdate,
        ...
        **kwargs,
        ...
        _all_params = ["batch_id", "batch_stock_update", "location_id"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
