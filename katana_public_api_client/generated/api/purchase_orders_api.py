...
class PurchaseOrdersApi:
    ...
    async def get_outsourced_purchase_order_recipe_rows(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, outsourced_purchase_order_id : Annotated[Optional[StrictInt], Field(description="Filter by outsourced purchase order ID")] = None, **kwargs) -> OutsourcedPurchaseOrderRecipeRowListResponse:  # noqa: E501
        ...
        return await self.get_outsourced_purchase_order_recipe_rows_with_http_info(limit, page, ids, outsourced_purchase_order_id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_outsourced_purchase_order_recipe_rows_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, outsourced_purchase_order_id : Annotated[Optional[StrictInt], Field(description="Filter by outsourced purchase order ID")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all outsourced purchase order recipe rows  # noqa: E501
        ...
        if _params.get('outsourced_purchase_order_id') is not None:  # noqa: E501
            _query_params.append(('outsourced_purchase_order_id', _params['outsourced_purchase_order_id']))
        ...
        return await self.api_client.call_api(
            '/outsourced_purchase_order_recipe_rows', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
