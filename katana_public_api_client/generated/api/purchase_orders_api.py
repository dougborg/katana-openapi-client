...
class PurchaseOrdersApi:
    ...
    @validate_arguments
    async def get_outsourced_purchase_order_recipe_rows(
        self,
        limit: Annotated[
            Optional[StrictInt],
        ...
        outsourced_purchase_order_id: Annotated[
            Optional[StrictInt],
            Field(description="Filter by outsourced purchase order ID"),
        ] = None,
        **kwargs,
    ) -> OutsourcedPurchaseOrderRecipeRowListResponse:  # noqa: E501
        """List all outsourced purchase order recipe rows  # noqa: E501

        Retrieves a list of outsourced purchase order recipe rows.  # noqa: E501
        ...
        :type ids: List[int]
        :param outsourced_purchase_order_id: Filter by outsourced purchase order ID
        :type outsourced_purchase_order_id: int
        ...
        :rtype: OutsourcedPurchaseOrderRecipeRowListResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_outsourced_purchase_order_recipe_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_outsourced_purchase_order_recipe_rows_with_http_info(
            limit, page, ids, outsourced_purchase_order_id, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_outsourced_purchase_order_recipe_rows_with_http_info(
        self,
        limit: Annotated[
            Optional[StrictInt],
            Field(description="Number of records to return per page."),
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(OutsourcedPurchaseOrderRecipeRowListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["limit", "page", "ids", "outsourced_purchase_order_id"]
        _all_params.extend(
            [
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_outsourced_purchase_order_recipe_rows" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("outsourced_purchase_order_id") is not None:  # noqa: E501
            _query_params.append(
                (
                    "outsourced_purchase_order_id",
                    _params["outsourced_purchase_order_id"],
                )
            )
