...
class LocationApi:
    ...
    async def get_all_locations(
        ...
        legal_name: Annotated[
            StrictStr | None, Field(description="Filters results by a legal name.")
        ] = None,
        address_id: Annotated[
            StrictInt | None, Field(description="Filters results by an address ID.")
        ] = None,
        ...
        rank: Annotated[
            StrictInt | None, Field(description="Filters results by a rank value.")
        ] = None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_locations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_location(
        self,
        id: Annotated[StrictFloat | StrictInt, Field(..., description="Location id")],
        **kwargs,
    ) -> Location:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_location_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_location_with_http_info(id, **kwargs)
