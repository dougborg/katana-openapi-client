...
class LocationApi:
    ...
    @validate_arguments
    async def get_all_locations(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filters additional costs by a name")] = None, legal_name : Annotated[Optional[StrictStr], Field(description="Filters results by a legal name.")] = None, address_id : Annotated[Optional[StrictInt], Field(description="Filters results by an address ID.")] = None, sales_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether sales are allowed.")] = None, manufacturing_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether manufacturing is allowed.")] = None, purchases_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether purchases are allowed.")] = None, rank : Annotated[Optional[StrictInt], Field(description="Filters results by a rank value.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> GetAllLocations200Response:  # noqa: E501
        ...
        return await self.get_all_locations_with_http_info(ids, name, legal_name, address_id, sales_allowed, manufacturing_allowed, purchases_allowed, rank, include_deleted, limit, page, created_at_min, created_at_max, updated_at_min, updated_at_max, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_locations_with_http_info(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, name : Annotated[Optional[StrictStr], Field(description="Filters additional costs by a name")] = None, legal_name : Annotated[Optional[StrictStr], Field(description="Filters results by a legal name.")] = None, address_id : Annotated[Optional[StrictInt], Field(description="Filters results by an address ID.")] = None, sales_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether sales are allowed.")] = None, manufacturing_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether manufacturing is allowed.")] = None, purchases_allowed : Annotated[Optional[StrictBool], Field(description="Filters results by whether purchases are allowed.")] = None, rank : Annotated[Optional[StrictInt], Field(description="Filters results by a rank value.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all locations  # noqa: E501
        ...
        if _params.get('manufacturing_allowed') is not None:  # noqa: E501
            _query_params.append(('manufacturing_allowed', _params['manufacturing_allowed']))
    ...
    @validate_arguments
    async def get_location(self, id : Annotated[Union[StrictFloat, StrictInt], Field(..., description="Location id")], **kwargs) -> Location:  # noqa: E501
    ...
    @validate_arguments
    async def get_location_with_http_info(self, id : Annotated[Union[StrictFloat, StrictInt], Field(..., description="Location id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a location  # noqa: E501
