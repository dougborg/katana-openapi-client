...
class PurchaseOrderApi:
    ...
    async def create_purchase_order(
        self,
        create_purchase_order_request: Annotated[
            CreatePurchaseOrderRequest,
            Field(..., description="new purchase order details"),
        ],
        **kwargs,
    ) -> PurchaseOrder:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the create_purchase_order_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.create_purchase_order_with_http_info(
            create_purchase_order_request, **kwargs
        )
    ...
    async def create_purchase_order_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["create_purchase_order_request"]
        _all_params.extend(
            [
    ...
    async def delete_purchase_order(
        self,
        id: Annotated[StrictInt, Field(..., description="Purchase order id")],
        **kwargs,
    ) -> None:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the delete_purchase_order_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.delete_purchase_order_with_http_info(id, **kwargs)

    @validate_arguments
    async def delete_purchase_order_with_http_info(
        self,
        id: Annotated[StrictInt, Field(..., description="Purchase order id")],
        **kwargs,
    ) -> ApiResponse:
    ...
    @validate_arguments
    async def find_purchase_orders(
        self,
        ids: Annotated[
        ...
        entity_type: Annotated[
            StrictStr | None,
            Field(description="Filters purchase orders by an entity type"),
        ] = None,
        status: Annotated[
            StrictStr | None,
            Field(description="Filters purchase orders by a status"),
        ] = None,
        billing_status: Annotated[
            StrictStr | None,
            Field(description="Filters purchase orders by a billing status"),
        ] = None,
        currency: Annotated[
            StrictStr | None,
        ...
        tracking_location_id: Annotated[
            ...
            Field(description="Filters purchase orders by a tracking location"),
        ] = None,
        supplier_id: Annotated[
            StrictFloat | StrictInt | None,
            Field(description="Filters purchase orders by a supplier"),
        ] = None,
        extend: Annotated[
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the find_purchase_orders_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.find_purchase_orders_with_http_info(
            ids,
            order_no,
            entity_type,
            status,
    ...
    @validate_arguments
    async def find_purchase_orders_with_http_info(
        self,
        ids: Annotated[
            conlist(StrictInt) | None,
            Field(description="Filters results by an array of IDs."),
        ...
        **kwargs,
        ...
        if _params.get("billing_status") is not None:
        ...
        if _params.get("tracking_location_id") is not None:
            _query_params.append(
                ("tracking_location_id", _params["tracking_location_id"])
            )

        if _params.get("supplier_id") is not None:
    ...
    async def get_purchase_order(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_purchase_order_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.get_purchase_order_with_http_info(id, extend, **kwargs)
    ...
    async def receive_purchase_order(
        self,
        purchase_order_receive_request: Annotated[
            PurchaseOrderReceiveRequest,
            Field(..., description="receive purchase order rows details"),
        ],
        **kwargs,
    ) -> None:
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the receive_purchase_order_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.receive_purchase_order_with_http_info(
            purchase_order_receive_request, **kwargs
        )
    ...
    async def receive_purchase_order_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["purchase_order_receive_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
    ...
    async def update_purchase_order(
        self,
        id: Annotated[StrictInt, Field(..., description="Purchase order id")],
        update_purchase_order_request: Annotated[
            UpdatePurchaseOrderRequest,
            Field(
        ...
        **kwargs,
        ...
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_purchase_order_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return await self.update_purchase_order_with_http_info(
            id, update_purchase_order_request, **kwargs
        )
    ...
    async def update_purchase_order_with_http_info(
        ...
        **kwargs,
        ...
        _all_params = ["id", "update_purchase_order_request"]
        _all_params.extend(
            [
                "_return_http_data_only",
                "_preload_content",
