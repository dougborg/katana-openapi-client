...
class ManufacturingOrderProductionIngredientApi:
    ...
    @validate_arguments
    async def update_manufacturing_order_production_ingredient(
        self,
        id: Annotated[
            StrictInt,
            Field(..., description="manufacturing order production ingredient id"),
        ],
        update_manufacturing_order_production_ingredient_request: Annotated[
            UpdateManufacturingOrderProductionIngredientRequest,
            Field(..., description="manufacturing order production ingredient details"),
        ],
        **kwargs,
    ) -> ManufacturingOrderProductionIngredientResponse:
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the update_manufacturing_order_production_ingredient_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
            raise ValueError(message)
        return (
            await self.update_manufacturing_order_production_ingredient_with_http_info(
                id, update_manufacturing_order_production_ingredient_request, **kwargs
            )
        )

    @validate_arguments
    async def update_manufacturing_order_production_ingredient_with_http_info(
        self,
        id: Annotated[
            StrictInt,
            Field(..., description="manufacturing order production ingredient id"),
        ...
        **kwargs,
        ...
        _all_params = ["id", "update_manufacturing_order_production_ingredient_request"]
        _all_params.extend(
            [
        ...
        _body_params = None
        if (
            _params["update_manufacturing_order_production_ingredient_request"]
            is not None
        ):
