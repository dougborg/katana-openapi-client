...
class StorageBinApi:
    ...
    @validate_arguments
    async def get_all_storage_bins(self, location_id : Annotated[Optional[StrictInt], Field(description="Filters results by a location ID.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, bin_name : Annotated[Optional[StrictStr], Field(description="Filters storage bins by name.")] = None, **kwargs) -> StorageBinListResponse:  # noqa: E501
        ...
        return await self.get_all_storage_bins_with_http_info(location_id, include_deleted, limit, page, bin_name, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_storage_bins_with_http_info(self, location_id : Annotated[Optional[StrictInt], Field(description="Filters results by a location ID.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, bin_name : Annotated[Optional[StrictStr], Field(description="Filters storage bins by name.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all storage bins  # noqa: E501
