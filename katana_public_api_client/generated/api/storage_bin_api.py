...
class StorageBinApi:
    ...
    @validate_arguments
    async def get_all_storage_bins(
        self,
        ...
        bin_name: Annotated[
            Optional[StrictStr], Field(description="Filters storage bins by name.")
        ] = None,
        **kwargs,
    ) -> StorageBinListResponse:  # noqa: E501
        """List all storage bins  # noqa: E501

        Returns a list of storage bins you've previously created. The storage bins are returned in sorted order, with the most recent storage bin appearing first.   # noqa: E501
        ...
        :type page: int
        :param bin_name: Filters storage bins by name.
        :type bin_name: str
        ...
        :rtype: StorageBinListResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_storage_bins_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_storage_bins_with_http_info(
            location_id, include_deleted, limit, page, bin_name, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_all_storage_bins_with_http_info(
        self,
        location_id: Annotated[
            Optional[StrictInt], Field(description="Filters results by a location ID.")
        ] = None,
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(StorageBinListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["location_id", "include_deleted", "limit", "page", "bin_name"]
        _all_params.extend(
            [
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_storage_bins" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
        ...
        if _params.get("bin_name") is not None:  # noqa: E501
            _query_params.append(("bin_name", _params["bin_name"]))
