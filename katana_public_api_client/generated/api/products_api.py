...
class ProductsApi:
    ...
    async def rerank_product_operations(
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the rerank_product_operations_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
