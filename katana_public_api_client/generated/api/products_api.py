...
class ProductsApi:
    ...
    @validate_arguments
    async def rerank_product_operations(self, product_operation_rerank_request : ProductOperationRerankRequest, **kwargs) -> ProductOperationRerank:  # noqa: E501
        ...
        return await self.rerank_product_operations_with_http_info(product_operation_rerank_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def rerank_product_operations_with_http_info(self, product_operation_rerank_request : ProductOperationRerankRequest, **kwargs) -> ApiResponse:  # noqa: E501
        """Rerank product operations  # noqa: E501
        ...
        _all_params = [
            'product_operation_rerank_request'
        ]
        _all_params.extend(
            [
