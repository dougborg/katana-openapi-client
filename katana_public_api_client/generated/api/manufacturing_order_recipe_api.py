...
class ManufacturingOrderRecipeApi:
    ...
    @validate_arguments
    async def create_manufacturing_order_recipe_rows(self, create_manufacturing_order_recipe_row_request : Annotated[CreateManufacturingOrderRecipeRowRequest, Field(..., description="new manufacturing order recipe details")], **kwargs) -> ManufacturingOrderRecipeRow:  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_manufacturing_order_recipe_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.create_manufacturing_order_recipe_rows_with_http_info(create_manufacturing_order_recipe_row_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def create_manufacturing_order_recipe_rows_with_http_info(self, create_manufacturing_order_recipe_row_request : Annotated[CreateManufacturingOrderRecipeRowRequest, Field(..., description="new manufacturing order recipe details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a manufacturing order recipe row  # noqa: E501
        ...
        _all_params = [
            'create_manufacturing_order_recipe_row_request'
        ]
        _all_params.extend(
            [
        ...
        return await self.api_client.call_api(
            '/manufacturing_order_recipe_rows', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def delete_manufacturing_order_recipe_row(self, id : Annotated[StrictInt, Field(..., description="Manufacturing order recipe id")], **kwargs) -> ErrorResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_manufacturing_order_recipe_row_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.delete_manufacturing_order_recipe_row_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    async def delete_manufacturing_order_recipe_row_with_http_info(self, id : Annotated[StrictInt, Field(..., description="Manufacturing order recipe id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete a manufacturing order recipe row  # noqa: E501
        ...
        return await self.api_client.call_api(
            '/manufacturing_order_recipe_rows/{id}', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    async def get_all_manufacturing_order_recipe_rows(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, manufacturing_order_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters manufacturing orders by location.")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filters results by a valid variant id.")] = None, ingredient_availability : Annotated[Optional[StrictStr], Field(description="Filters manufacturing orders by an ingredient availability.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ManufacturingOrderRecipeRowListResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_manufacturing_order_recipe_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_manufacturing_order_recipe_rows_with_http_info(ids, manufacturing_order_id, variant_id, ingredient_availability, include_deleted, limit, page, created_at_min, created_at_max, updated_at_min, updated_at_max, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_manufacturing_order_recipe_rows_with_http_info(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, manufacturing_order_id : Annotated[Optional[Union[StrictFloat, StrictInt]], Field(description="Filters manufacturing orders by location.")] = None, variant_id : Annotated[Optional[StrictInt], Field(description="Filters results by a valid variant id.")] = None, ingredient_availability : Annotated[Optional[StrictStr], Field(description="Filters manufacturing orders by an ingredient availability.")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all manufacturing order recipe rows  # noqa: E501
        ...
        if _params.get('ingredient_availability') is not None:  # noqa: E501
            _query_params.append(('ingredient_availability', _params['ingredient_availability']))
        ...
        return await self.api_client.call_api(
            '/manufacturing_order_recipe_rows', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def get_manufacturing_order_recipe_row(self, id : Annotated[Union[StrictFloat, StrictInt], Field(..., description="Manufacturing order recipe row id")], **kwargs) -> ManufacturingOrderRecipeRow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_manufacturing_order_recipe_row_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_manufacturing_order_recipe_row_with_http_info(id, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_manufacturing_order_recipe_row_with_http_info(self, id : Annotated[Union[StrictFloat, StrictInt], Field(..., description="Manufacturing order recipe row id")], **kwargs) -> ApiResponse:  # noqa: E501
        """Retrieve a manufacturing order recipe row  # noqa: E501
        ...
        return await self.api_client.call_api(
            '/manufacturing_order_recipe_rows/{id}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    async def update_manufacturing_order_recipe_rows(self, id : Annotated[StrictInt, Field(..., description="manufacturing order recipe id")], update_manufacturing_order_recipe_row_request : Annotated[UpdateManufacturingOrderRecipeRowRequest, Field(..., description="manufacturing order recipe details")], **kwargs) -> ManufacturingOrderRecipeRow:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_manufacturing_order_recipe_rows_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.update_manufacturing_order_recipe_rows_with_http_info(id, update_manufacturing_order_recipe_row_request, **kwargs)  # noqa: E501

    @validate_arguments
    async def update_manufacturing_order_recipe_rows_with_http_info(self, id : Annotated[StrictInt, Field(..., description="manufacturing order recipe id")], update_manufacturing_order_recipe_row_request : Annotated[UpdateManufacturingOrderRecipeRowRequest, Field(..., description="manufacturing order recipe details")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update a manufacturing order recipe row  # noqa: E501
        ...
        _all_params = [
            'id',
            'update_manufacturing_order_recipe_row_request'
        ]
        _all_params.extend(
            [
                '_return_http_data_only',
        ...
        return await self.api_client.call_api(
            '/manufacturing_order_recipe_rows/{id}', 'PATCH',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
