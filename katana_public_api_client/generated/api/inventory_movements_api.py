...
class InventoryMovementsApi:
    ...
    async def get_all_inventory_movements(
        ...
        resource_type: Annotated[
            StrictStr | None, Field(description="Filters results by resource type.")
        ] = None,
        resource_id: Annotated[
            StrictInt | None, Field(description="Filters results by a resource ID.")
        ] = None,
        ...
        **kwargs,
        ...
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_inventory_movements_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"
    ...
    async def get_all_inventory_movements_with_http_info(
        ...
        **kwargs,
        ...
        if _params.get("caused_by_order_no") is not None:
            _query_params.append(("caused_by_order_no", _params["caused_by_order_no"]))

        if _params.get("caused_by_resource_id") is not None:
