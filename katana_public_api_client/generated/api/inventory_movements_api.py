...
class InventoryMovementsApi:
    ...
    @validate_arguments
    async def get_all_inventory_movements(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, variant_ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of variant IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filters results by a location ID.")] = None, resource_type : Annotated[Optional[StrictStr], Field(description="Filters results by resource type.")] = None, resource_id : Annotated[Optional[StrictInt], Field(description="Filters results by a resource ID.")] = None, caused_by_order_no : Annotated[Optional[StrictStr], Field(description="Filters results by the causing order number.")] = None, caused_by_resource_id : Annotated[Optional[StrictInt], Field(description="Filters results by the causing resource ID.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> InventoryMovementListResponse:  # noqa: E501
        """List all inventory movements  # noqa: E501

        Returns a list of inventory movements created by your Katana resources. The inventory movements are returned in sorted order, with the most recent movements appearing first.   # noqa: E501
        ...
        :param resource_type: Filters results by resource type.
        :type resource_type: str
        :param resource_id: Filters results by a resource ID.
        :type resource_id: int
        :param caused_by_order_no: Filters results by the causing order number.
        :type caused_by_order_no: str
        :param caused_by_resource_id: Filters results by the causing resource ID.
        :type caused_by_resource_id: int
        ...
        :rtype: InventoryMovementListResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_all_inventory_movements_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_inventory_movements_with_http_info(ids, variant_ids, location_id, resource_type, resource_id, caused_by_order_no, caused_by_resource_id, limit, page, created_at_min, created_at_max, updated_at_min, updated_at_max, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_inventory_movements_with_http_info(self, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, variant_ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of variant IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filters results by a location ID.")] = None, resource_type : Annotated[Optional[StrictStr], Field(description="Filters results by resource type.")] = None, resource_id : Annotated[Optional[StrictInt], Field(description="Filters results by a resource ID.")] = None, caused_by_order_no : Annotated[Optional[StrictStr], Field(description="Filters results by the causing order number.")] = None, caused_by_resource_id : Annotated[Optional[StrictInt], Field(description="Filters results by the causing resource ID.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, created_at_min : Annotated[Optional[datetime], Field(description="Minimum creation date (ISO 8601 format).")] = None, created_at_max : Annotated[Optional[datetime], Field(description="Maximum creation date (ISO 8601 format).")] = None, updated_at_min : Annotated[Optional[datetime], Field(description="Minimum update date (ISO 8601 format).")] = None, updated_at_max : Annotated[Optional[datetime], Field(description="Maximum update date (ISO 8601 format).")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all inventory movements  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(InventoryMovementListResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_inventory_movements" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params.get('caused_by_order_no') is not None:  # noqa: E501
            _query_params.append(('caused_by_order_no', _params['caused_by_order_no']))

        if _params.get('caused_by_resource_id') is not None:  # noqa: E501
            _query_params.append(('caused_by_resource_id', _params['caused_by_resource_id']))
