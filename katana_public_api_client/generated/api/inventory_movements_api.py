...
class InventoryMovementsApi:
    ...
    @validate_arguments
    async def get_all_inventory_movements(
        self,
        ids: Annotated[
        ...
        resource_type: Annotated[
            Optional[StrictStr], Field(description="Filters results by resource type.")
        ] = None,
        resource_id: Annotated[
            Optional[StrictInt], Field(description="Filters results by a resource ID.")
        ] = None,
        caused_by_order_no: Annotated[
            Optional[StrictStr],
            Field(description="Filters results by the causing order number."),
        ] = None,
        caused_by_resource_id: Annotated[
            Optional[StrictInt],
            Field(description="Filters results by the causing resource ID."),
        ] = None,
        limit: Annotated[
            Optional[StrictInt],
        ...
        **kwargs,
    ) -> InventoryMovementListResponse:  # noqa: E501
        ...
        return await self.get_all_inventory_movements_with_http_info(
            ids,
            variant_ids,
            location_id,
            resource_type,
    ...
    @validate_arguments
    async def get_all_inventory_movements_with_http_info(
        self,
        ids: Annotated[
            Optional[conlist(StrictInt)],
            Field(description="Filters results by an array of IDs."),
        ...
        **kwargs,
        ...
        if _params.get("caused_by_resource_id") is not None:  # noqa: E501
            _query_params.append(
                ("caused_by_resource_id", _params["caused_by_resource_id"])
            )
