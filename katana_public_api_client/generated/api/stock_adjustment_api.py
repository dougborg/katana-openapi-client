...
class StockAdjustmentApi:
    ...
    async def get_all_stock_adjustments(
        ...
        **kwargs,
    ) -> StockAdjustmentListResponse:  # noqa: E501
        """List all stock adjustments  # noqa: E501

        Returns a list of stock adjustments.  # noqa: E501
        ...
        :rtype: StockAdjustmentListResponse
        """
        kwargs["_return_http_data_only"] = True
        if "_preload_content" in kwargs:
            message = "Error! Please call the get_all_stock_adjustments_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return await self.get_all_stock_adjustments_with_http_info(
            limit, page, ids, location_id, include_deleted, **kwargs
        )  # noqa: E501

    @validate_arguments
    async def get_all_stock_adjustments_with_http_info(
        self,
        limit: Annotated[
            Optional[StrictInt],
            Field(description="Number of records to return per page."),
        ...
        **kwargs,
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(StockAdjustmentListResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = ["limit", "page", "ids", "location_id", "include_deleted"]
        _all_params.extend(
            [
        ...
        for _key, _val in _params["kwargs"].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_all_stock_adjustments" % _key
                )
            _params[_key] = _val
        del _params["kwargs"]
