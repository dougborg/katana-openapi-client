...
class StockAdjustmentApi:
    ...
    async def get_all_stock_adjustments(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filter by location ID")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> StockAdjustmentListResponse:  # noqa: E501
        ...
        return await self.get_all_stock_adjustments_with_http_info(limit, page, ids, location_id, include_deleted, **kwargs)  # noqa: E501

    @validate_arguments
    async def get_all_stock_adjustments_with_http_info(self, limit : Annotated[Optional[StrictInt], Field(description="Number of records to return per page.")] = None, page : Annotated[Optional[StrictInt], Field(description="Page number to return.")] = None, ids : Annotated[Optional[conlist(StrictInt)], Field(description="Filters results by an array of IDs.")] = None, location_id : Annotated[Optional[StrictInt], Field(description="Filter by location ID")] = None, include_deleted : Annotated[Optional[StrictBool], Field(description="Include soft-deleted items.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List all stock adjustments  # noqa: E501
