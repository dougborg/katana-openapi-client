...
class StockAdjustmentListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(StockAdjustment)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StockAdjustmentListResponse:
        """Create an instance of StockAdjustmentListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StockAdjustmentListResponse:
        """Create an instance of StockAdjustmentListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StockAdjustmentListResponse.parse_obj(obj)

        _obj = StockAdjustmentListResponse.parse_obj({
            "data": [StockAdjustment.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
