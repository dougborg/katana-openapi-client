...
class VariantAllOfCustomFields(BaseModel):
    """
    VariantAllOfCustomFields
    """

    field_name: StrictStr | None = None
    field_value: StrictStr | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariantAllOfCustomFields:
        """Create an instance of VariantAllOfCustomFields from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariantAllOfCustomFields:
        """Create an instance of VariantAllOfCustomFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariantAllOfCustomFields.parse_obj(obj)

        _obj = VariantAllOfCustomFields.parse_obj(
