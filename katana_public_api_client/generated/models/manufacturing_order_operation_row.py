...
class ManufacturingOrderOperationRow(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "status", "type", "rank", "manufacturing_order_id", "operation_id", "operation_name", "resource_id", "resource_name", "assigned_operators", "completed_by_operators", "active_operator_id", "planned_time_per_unit", "planned_time_parameter", "total_actual_time", "planned_cost_per_unit", "total_actual_cost", "cost_per_hour", "cost_parameter", "group_boundary", "is_status_actionable", "completed_at"]
