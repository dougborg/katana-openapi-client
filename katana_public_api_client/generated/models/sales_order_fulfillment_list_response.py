...
class SalesOrderFulfillmentListResponse(BaseModel):
    """
    SalesOrderFulfillmentListResponse
    """

    data: Optional[conlist(SalesOrderFulfillment)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderFulfillmentListResponse:
        """Create an instance of SalesOrderFulfillmentListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderFulfillmentListResponse:
        """Create an instance of SalesOrderFulfillmentListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderFulfillmentListResponse.parse_obj(obj)

        _obj = SalesOrderFulfillmentListResponse.parse_obj(
            {
                "data": [
                    SalesOrderFulfillment.from_dict(_item) for _item in obj.get("data")
                ]
