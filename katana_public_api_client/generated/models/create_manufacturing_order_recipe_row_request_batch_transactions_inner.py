...
class CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner(BaseModel):
    """
    CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner
    """
    batch_id: StrictInt = Field(...)
    quantity: Union[StrictFloat, StrictInt] = Field(...)
    __properties = ["batch_id", "quantity"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner:
        """Create an instance of CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner:
        """Create an instance of CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner.parse_obj(obj)

        _obj = CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner.parse_obj({
