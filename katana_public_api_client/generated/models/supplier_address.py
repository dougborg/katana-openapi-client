...
class SupplierAddress(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "supplier_id", "line_1", "line_2", "city", "state", "zip", "country"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupplierAddress:
        """Create an instance of SupplierAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SupplierAddress:
        """Create an instance of SupplierAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupplierAddress.parse_obj(obj)

        _obj = SupplierAddress.parse_obj({
