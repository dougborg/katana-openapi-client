...
class CreateVariantRequestCustomFieldsInner(BaseModel):
    """
    CreateVariantRequestCustomFieldsInner
    """

    field_name: StrictStr = Field(...)
    field_value: StrictStr = Field(...)
    __properties = ["field_name", "field_value"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVariantRequestCustomFieldsInner:
        """Create an instance of CreateVariantRequestCustomFieldsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVariantRequestCustomFieldsInner:
        """Create an instance of CreateVariantRequestCustomFieldsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateVariantRequestCustomFieldsInner.parse_obj(obj)

        _obj = CreateVariantRequestCustomFieldsInner.parse_obj(
            {"field_name": obj.get("field_name"), "field_value": obj.get("field_value")}
        )
        return _obj
