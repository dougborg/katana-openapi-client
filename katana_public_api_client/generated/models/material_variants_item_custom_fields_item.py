...
T = TypeVar("T", bound="MaterialVariantsItemCustomFieldsItem")


@_attrs_define
class MaterialVariantsItemCustomFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        material_variants_item_custom_fields_item = cls(
            field_name=field_name,
            field_value=field_value,
        )

        material_variants_item_custom_fields_item.additional_properties = d
        return material_variants_item_custom_fields_item
