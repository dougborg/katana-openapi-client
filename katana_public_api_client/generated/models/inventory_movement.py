...
class InventoryMovement(BaseModel):
    ...
    caused_by_order_no: StrictStr | None = Field(
        default=None, description="Order number that triggered the movement."
    )
    caused_by_resource_id: StrictInt | None = Field(
        default=None,
