...
class InventoryMovement(BaseModel):
    ...
    id: StrictInt = Field(
        default=..., description="Unique identifier for the inventory movement."
    )
    ...
    resource_type: StrictStr = Field(
        default=..., description="The type of resource that caused the movement."
    )
    resource_id: Optional[StrictInt] = Field(
        default=None,
        description="Identifier of the resource that initiated the movement.",
    )
    caused_by_order_no: Optional[StrictStr] = Field(
        default=None, description="Order number that triggered the movement."
    )
    caused_by_resource_id: Optional[StrictInt] = Field(
        default=None,
        description="Identifier for the resource that caused the movement.",
    )
    movement_date: datetime = Field(
        default=..., description="Date and time when the inventory movement occurred."
    )
    quantity_change: Union[StrictFloat, StrictInt] = Field(
        default=..., description="The change in quantity as a result of the movement."
    )
    balance_after: Union[StrictFloat, StrictInt] = Field(
        default=..., description="The quantity balance after the movement."
    )
    value_per_unit: Union[StrictFloat, StrictInt] = Field(
        default=..., description="The value per unit for the movement."
    )
    value_in_stock_after: Union[StrictFloat, StrictInt] = Field(
        default=..., description="The total value in stock after the movement."
    )
    average_cost_after: Union[StrictFloat, StrictInt] = Field(
        default=..., description="The average cost per unit after the movement."
    )
    rank: Optional[StrictInt] = Field(
        default=None, description="A rank or order index for the movement."
    )
    __properties = [
        "created_at",
        "updated_at",
    ...
    def resource_type_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('PurchaseOrderRow', 'PurchaseOrderRecipeRow', 'SalesOrderRow', 'ManufacturingOrderRecipeRow', 'StockAdjustmentRow', 'StockTransferRow', 'ManufacturingOrder', 'SystemGenerated')"
            )
        return value
