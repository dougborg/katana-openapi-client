...
class CreateSalesOrderRequest(BaseModel):
    ...
    delivery_date: StrictStr | None = None
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if (
            self.order_created_date is None
            and "order_created_date" in self.__fields_set__
        ):
        ...
        _obj = CreateSalesOrderRequest.parse_obj(
            {
                ...
                "sales_order_rows": [
                    CreateSalesOrderRequestSalesOrderRowsInner.from_dict(_item)
