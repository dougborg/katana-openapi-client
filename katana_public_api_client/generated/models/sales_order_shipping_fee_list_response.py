...
class SalesOrderShippingFeeListResponse(BaseModel):
    """
    SalesOrderShippingFeeListResponse
    """
    data: Optional[conlist(SalesOrderShippingFee)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderShippingFeeListResponse:
        """Create an instance of SalesOrderShippingFeeListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderShippingFeeListResponse:
        """Create an instance of SalesOrderShippingFeeListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderShippingFeeListResponse.parse_obj(obj)

        _obj = SalesOrderShippingFeeListResponse.parse_obj({
            "data": [SalesOrderShippingFee.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
