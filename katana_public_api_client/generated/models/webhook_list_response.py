...
class WebhookListResponse(BaseModel):
    ...
    data: conlist(Webhook) | None = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookListResponse:
        """Create an instance of WebhookListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookListResponse.parse_obj(obj)

        _obj = WebhookListResponse.parse_obj(
            {
                "data": [Webhook.from_dict(_item) for _item in obj.get("data")]
