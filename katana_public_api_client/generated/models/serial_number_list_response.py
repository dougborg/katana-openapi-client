...
class SerialNumberListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(SerialNumber)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SerialNumberListResponse:
        """Create an instance of SerialNumberListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SerialNumberListResponse:
        """Create an instance of SerialNumberListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SerialNumberListResponse.parse_obj(obj)

        _obj = SerialNumberListResponse.parse_obj({
            "data": [SerialNumber.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
