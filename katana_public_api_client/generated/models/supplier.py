...
class Supplier(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "name", "email", "phone", "currency", "comment", "default_address_id", "addresses"]
    ...
    def from_dict(cls, obj: dict) -> Supplier:
        ...
        _obj = Supplier.parse_obj({
            ...
            "addresses": [SupplierAddress.from_dict(_item) for _item in obj.get("addresses")] if obj.get("addresses") is not None else None
        })
        return _obj
