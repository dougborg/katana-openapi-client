...
class ManufacturingOrderProduction(BaseModel):
    ...
    ingredients: conlist(ManufacturingOrderProductionIngredient) | None = None
    operations: conlist(ManufacturingOrderOperationProduction) | None = None
        ...
        _obj = ManufacturingOrderProduction.parse_obj(
            {
                ...
                "ingredients": [
                    ManufacturingOrderProductionIngredient.from_dict(_item)
                    for _item in obj.get("ingredients")
                ]
                if obj.get("ingredients") is not None
                else None,
                "operations": [
                    ManufacturingOrderOperationProduction.from_dict(_item)
