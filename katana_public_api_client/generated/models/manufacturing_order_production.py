...
class ManufacturingOrderProduction:
    """A manufacturing order production represents a production run for a manufacturing order

    Example:
        {'id': 3001, 'manufacturing_order_id': 21400, 'quantity': 5, 'production_date': '2021-09-01T07:49:29.000Z',
            'ingredients': [], 'operations': [], 'serial_numbers': [], 'created_at': '2021-09-01T07:49:29.813Z',
            'updated_at': '2021-09-01T08:15:30.000Z', 'deleted_at': None}
    """
