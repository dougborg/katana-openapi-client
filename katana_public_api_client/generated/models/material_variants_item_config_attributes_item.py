...
T = TypeVar("T", bound="MaterialVariantsItemConfigAttributesItem")


@_attrs_define
class MaterialVariantsItemConfigAttributesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        material_variants_item_config_attributes_item = cls(
            config_name=config_name,
            config_value=config_value,
        )

        material_variants_item_config_attributes_item.additional_properties = d
        return material_variants_item_config_attributes_item
