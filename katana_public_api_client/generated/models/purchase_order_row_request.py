...
class PurchaseOrderRowRequest(BaseModel):
    """
    ...
    __properties = ["quantity", "price_per_unit", "purchase_uom_conversion_rate", "purchase_uom"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderRowRequest:
        """Create an instance of PurchaseOrderRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderRowRequest:
        """Create an instance of PurchaseOrderRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderRowRequest.parse_obj(obj)

        _obj = PurchaseOrderRowRequest.parse_obj({
