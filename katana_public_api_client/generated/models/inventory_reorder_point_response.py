...
class InventoryReorderPointResponse(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryReorderPointResponse:
        """Create an instance of InventoryReorderPointResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryReorderPointResponse:
        """Create an instance of InventoryReorderPointResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryReorderPointResponse.parse_obj(obj)

        _obj = InventoryReorderPointResponse.parse_obj({
