...
class CreateBomRowRequest(BaseModel):
    """
    CreateBomRowRequest
    """

    product_variant_id: StrictInt = Field(...)
    ingredient_variant_id: StrictInt = Field(...)
    quantity: Union[StrictFloat, StrictInt] = Field(...)
    notes: Optional[StrictStr] = None
    __properties = ["product_variant_id", "ingredient_variant_id", "quantity", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBomRowRequest:
        """Create an instance of CreateBomRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBomRowRequest:
        """Create an instance of CreateBomRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBomRowRequest.parse_obj(obj)

        _obj = CreateBomRowRequest.parse_obj(
            {
