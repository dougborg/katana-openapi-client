...
class NegativeStock(BaseModel):
    ...
    latest_negative_stock_date: Optional[datetime] = None
    name: Optional[StrictStr] = None
    sku: Optional[StrictStr] = None
    category: Optional[StrictStr] = None
    __properties = ["variant_id", "location_id", "latest_negative_stock_date", "name", "sku", "category"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NegativeStock:
        """Create an instance of NegativeStock from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NegativeStock:
        """Create an instance of NegativeStock from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NegativeStock.parse_obj(obj)

        _obj = NegativeStock.parse_obj({
            "variant_id": obj.get("variant_id"),
            "location_id": obj.get("location_id"),
            "latest_negative_stock_date": obj.get("latest_negative_stock_date"),
            "name": obj.get("name"),
            "sku": obj.get("sku"),
