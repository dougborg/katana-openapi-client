...
class CreateVariantRequest(BaseModel):
    ...
    """
    sku: StrictStr = Field(...)
    sales_price: Optional[Union[confloat(le=100000000000, ge=0, strict=True), conint(le=2147483647, ge=0, strict=True)]] = None
    purchase_price: Optional[Union[confloat(le=100000000000, ge=0, strict=True), conint(le=2147483647, ge=0, strict=True)]] = None
    product_id: Optional[conint(strict=True, le=2147483647)] = None
    material_id: Optional[conint(strict=True, le=2147483647)] = None
    supplier_item_codes: conlist(StrictStr, min_items=1) = Field(...)
    ...
    config_attributes: Optional[conlist(CreateVariantRequestConfigAttributesInner)] = None
    custom_fields: Optional[conlist(CreateVariantRequestCustomFieldsInner)] = None
    additional_properties: Dict[str, Any] = {}
    __properties = ["sku", "sales_price", "purchase_price", "product_id", "material_id", "supplier_item_codes", "internal_barcode", "registered_barcode", "lead_time", "minimum_order_quantity", "config_attributes", "custom_fields"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVariantRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVariantRequest:
        """Create an instance of CreateVariantRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateVariantRequest.parse_obj(obj)

        _obj = CreateVariantRequest.parse_obj({
            "sku": obj.get("sku"),
            ...
            "config_attributes": [CreateVariantRequestConfigAttributesInner.from_dict(_item) for _item in obj.get("config_attributes")] if obj.get("config_attributes") is not None else None,
            "custom_fields": [CreateVariantRequestCustomFieldsInner.from_dict(_item) for _item in obj.get("custom_fields")] if obj.get("custom_fields") is not None else None
        })
