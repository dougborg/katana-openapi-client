...
class Stocktake(BaseModel):
    ...
    stocktake_date: Optional[datetime] = None
    notes: Optional[StrictStr] = None
    __properties = ["created_at", "updated_at", "id", "reference_no", "location_id", "status", "stocktake_date", "notes"]

    @validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('DRAFT', 'IN_PROGRESS', 'COMPLETED',):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Stocktake:
        """Create an instance of Stocktake from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Stocktake:
        """Create an instance of Stocktake from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Stocktake.parse_obj(obj)

        _obj = Stocktake.parse_obj({
            ...
            "stocktake_date": obj.get("stocktake_date"),
            "notes": obj.get("notes")
        })
        return _obj
