...
class CreateManufacturingOrderRecipeRowRequest(BaseModel):
    ...
    planned_quantity_per_unit: StrictFloat | StrictInt = Field(...)
    ...
    batch_transactions: (
        conlist(CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner) | None
    ) = None
        ...
        _obj = CreateManufacturingOrderRecipeRowRequest.parse_obj(
            {
                ...
                "batch_transactions": [
                    CreateManufacturingOrderRecipeRowRequestBatchTransactionsInner.from_dict(
                        _item
                    )
