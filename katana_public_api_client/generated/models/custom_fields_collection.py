...
class CustomFieldsCollection(BaseModel):
    ...
    custom_fields: Optional[conlist(CustomFieldsCollectionAllOfCustomFields)] = None
    __properties = ["created_at", "updated_at", "id", "name", "resource_type", "custom_fields"]

    @validator('resource_type')
    def resource_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('product', 'material', 'variant', 'customer', 'sales_order', 'purchase_order', 'stocktake',):
            raise ValueError("must be one of enum values ('product', 'material', 'variant', 'customer', 'sales_order', 'purchase_order', 'stocktake')")
        return value
    ...
    def from_dict(cls, obj: dict) -> CustomFieldsCollection:
        ...
        _obj = CustomFieldsCollection.parse_obj({
            ...
            "custom_fields": [CustomFieldsCollectionAllOfCustomFields.from_dict(_item) for _item in obj.get("custom_fields")] if obj.get("custom_fields") is not None else None
        })
        return _obj
