...
class UpdateManufacturingOrderProductionIngredientRequest(BaseModel):
    """
    ...
    __properties = ["quantity", "production_date", "cost"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateManufacturingOrderProductionIngredientRequest:
        """Create an instance of UpdateManufacturingOrderProductionIngredientRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateManufacturingOrderProductionIngredientRequest:
        """Create an instance of UpdateManufacturingOrderProductionIngredientRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateManufacturingOrderProductionIngredientRequest.parse_obj(obj)

        _obj = UpdateManufacturingOrderProductionIngredientRequest.parse_obj({
