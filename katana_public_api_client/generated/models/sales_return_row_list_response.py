...
class SalesReturnRowListResponse(BaseModel):
    """
    SalesReturnRowListResponse
    """
    data: Optional[conlist(SalesReturnRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesReturnRowListResponse:
        """Create an instance of SalesReturnRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesReturnRowListResponse:
        """Create an instance of SalesReturnRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesReturnRowListResponse.parse_obj(obj)

        _obj = SalesReturnRowListResponse.parse_obj({
            "data": [SalesReturnRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
