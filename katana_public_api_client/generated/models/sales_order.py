...
from ..models.sales_order_ingredient_availability_type_0 import SalesOrderIngredientAvailabilityType0
from ..models.sales_order_product_availability_type_0 import SalesOrderProductAvailabilityType0
from ..models.sales_order_production_status_type_0 import SalesOrderProductionStatusType0
...
class SalesOrder:
    ...
    product_availability: Union[None, SalesOrderProductAvailabilityType0, Unset] = UNSET
    product_expected_date: Union[None, Unset, datetime.datetime] = UNSET
    ingredient_availability: Union[None, SalesOrderIngredientAvailabilityType0, Unset] = UNSET
    ingredient_expected_date: Union[None, Unset, datetime.datetime] = UNSET
    production_status: Union[None, SalesOrderProductionStatusType0, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.ingredient_availability, SalesOrderIngredientAvailabilityType0):
        ...
        production_status: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_conversion_date(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        ecommerce_order_type = _parse_ecommerce_order_type(d.pop("ecommerce_order_type", UNSET))
        ...
        ecommerce_store_name = _parse_ecommerce_store_name(d.pop("ecommerce_store_name", UNSET))
        ...
        ecommerce_order_id = _parse_ecommerce_order_id(d.pop("ecommerce_order_id", UNSET))

        def _parse_product_availability(data: object) -> Union[None, SalesOrderProductAvailabilityType0, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, SalesOrderProductAvailabilityType0, Unset], data)

        product_availability = _parse_product_availability(d.pop("product_availability", UNSET))

        def _parse_product_expected_date(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        product_expected_date = _parse_product_expected_date(d.pop("product_expected_date", UNSET))

        def _parse_ingredient_availability(data: object) -> Union[None, SalesOrderIngredientAvailabilityType0, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                ingredient_availability_type_0 = SalesOrderIngredientAvailabilityType0(data)

                return ingredient_availability_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, SalesOrderIngredientAvailabilityType0, Unset], data)

        ingredient_availability = _parse_ingredient_availability(d.pop("ingredient_availability", UNSET))

        def _parse_ingredient_expected_date(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_production_status(data: object) -> Union[None, SalesOrderProductionStatusType0, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(Union[None, SalesOrderProductionStatusType0, Unset], data)
        ...
        billing_address_id = _parse_billing_address_id(d.pop("billing_address_id", UNSET))
        ...
        shipping_address_id = _parse_shipping_address_id(d.pop("shipping_address_id", UNSET))
