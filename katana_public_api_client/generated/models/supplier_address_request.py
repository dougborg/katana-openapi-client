...
class SupplierAddressRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupplierAddressRequest:
        """Create an instance of SupplierAddressRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SupplierAddressRequest:
        """Create an instance of SupplierAddressRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupplierAddressRequest.parse_obj(obj)

        _obj = SupplierAddressRequest.parse_obj({
