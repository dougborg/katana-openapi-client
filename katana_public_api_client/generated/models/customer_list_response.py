...
class CustomerListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(Customer)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerListResponse:
        """Create an instance of CustomerListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerListResponse.parse_obj(obj)

        _obj = CustomerListResponse.parse_obj({
            "data": [Customer.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
