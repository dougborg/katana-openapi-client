...
class InventorySafetyStockLevelResponse(BaseModel):
    """
    ...
    value: Union[confloat(le=100000000000000000, strict=True), conint(le=2147483647, strict=True)] = Field(...)
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    deleted_at: Optional[StrictStr] = Field(default=None, description="Nullable deletion timestamp")
    __properties = ["location_id", "variant_id", "value", "created_at", "updated_at", "deleted_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventorySafetyStockLevelResponse:
        """Create an instance of InventorySafetyStockLevelResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventorySafetyStockLevelResponse:
        """Create an instance of InventorySafetyStockLevelResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventorySafetyStockLevelResponse.parse_obj(obj)

        _obj = InventorySafetyStockLevelResponse.parse_obj({
