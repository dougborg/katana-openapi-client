...
class SalesOrderAddressListResponse(BaseModel):
    """
    SalesOrderAddressListResponse
    """
    data: Optional[conlist(SalesOrderAddress)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderAddressListResponse:
        """Create an instance of SalesOrderAddressListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderAddressListResponse:
        """Create an instance of SalesOrderAddressListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderAddressListResponse.parse_obj(obj)

        _obj = SalesOrderAddressListResponse.parse_obj({
            "data": [SalesOrderAddress.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
