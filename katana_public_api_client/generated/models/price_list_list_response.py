...
class PriceListListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(PriceList)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceListListResponse:
        """Create an instance of PriceListListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceListListResponse:
        """Create an instance of PriceListListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceListListResponse.parse_obj(obj)

        _obj = PriceListListResponse.parse_obj({
            "data": [PriceList.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
