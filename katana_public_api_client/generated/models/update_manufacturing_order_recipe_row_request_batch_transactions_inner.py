...
class UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner:
        """Create an instance of UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner:
        """Create an instance of UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner.parse_obj(obj)

        _obj = UpdateManufacturingOrderRecipeRowRequestBatchTransactionsInner.parse_obj({
