...
class VariantDefaultStorageBinLinkResponse(BaseModel):
    """
    ...
    bin_name: Optional[StrictStr] = None
    variant_id: Optional[StrictInt] = None
    storage_bin_id: Optional[StrictInt] = None
    __properties = ["created_at", "updated_at", "deleted_at", "id", "bin_name", "variant_id", "storage_bin_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariantDefaultStorageBinLinkResponse:
        """Create an instance of VariantDefaultStorageBinLinkResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariantDefaultStorageBinLinkResponse:
        """Create an instance of VariantDefaultStorageBinLinkResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariantDefaultStorageBinLinkResponse.parse_obj(obj)

        _obj = VariantDefaultStorageBinLinkResponse.parse_obj({
            ...
            "storage_bin_id": obj.get("storage_bin_id")
        })
        return _obj
