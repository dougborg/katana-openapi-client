...
class WebhookEvent(str, Enum):
    ...
    OUTSOURCED_PURCHASE_ORDER_ROW_DOT_RECEIVED = (
        "outsourced_purchase_order_row.received"
    )
    OUTSOURCED_PURCHASE_ORDER_RECIPE_ROW_DOT_CREATED = (
        "outsourced_purchase_order_recipe_row.created"
    )
    OUTSOURCED_PURCHASE_ORDER_RECIPE_ROW_DOT_UPDATED = (
        "outsourced_purchase_order_recipe_row.updated"
    )
    OUTSOURCED_PURCHASE_ORDER_RECIPE_ROW_DOT_DELETED = (
    ...
    MANUFACTURING_ORDER_RECIPE_ROW_DOT_CREATED = (
        "manufacturing_order_recipe_row.created"
    )
    MANUFACTURING_ORDER_RECIPE_ROW_DOT_UPDATED = (
        "manufacturing_order_recipe_row.updated"
    )
    MANUFACTURING_ORDER_RECIPE_ROW_DOT_DELETED = (
        "manufacturing_order_recipe_row.deleted"
    )
    MANUFACTURING_ORDER_RECIPE_ROW_DOT_INGREDIENTS_IN_STOCK = (
        "manufacturing_order_recipe_row.ingredients_in_stock"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_CREATED = (
        "manufacturing_order_operation_row.created"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_UPDATED = (
        "manufacturing_order_operation_row.updated"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_DELETED = (
        "manufacturing_order_operation_row.deleted"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_IN_PROGRESS = (
        "manufacturing_order_operation_row.in_progress"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_PAUSED = (
        "manufacturing_order_operation_row.paused"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_BLOCKED = (
        "manufacturing_order_operation_row.blocked"
    )
    MANUFACTURING_ORDER_OPERATION_ROW_DOT_COMPLETED = (
    ...
    CURRENT_INVENTORY_DOT_PRODUCT_OUT_OF_STOCK = (
        "current_inventory.product_out_of_stock"
    )
    CURRENT_INVENTORY_DOT_MATERIAL_OUT_OF_STOCK = (
