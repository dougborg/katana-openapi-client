...
class CreatePurchaseOrderAdditionalCostRowRequest(BaseModel):
    """
    CreatePurchaseOrderAdditionalCostRowRequest
    """
    additional_cost_id: StrictInt = Field(...)
    group_id: StrictInt = Field(...)
    tax_rate_id: StrictInt = Field(...)
    price: Union[confloat(le=100000000000000000, ge=0, strict=True), conint(le=2147483647, ge=0, strict=True)] = Field(...)
    distribution_method: Optional[StrictStr] = None
    __properties = ["additional_cost_id", "group_id", "tax_rate_id", "price", "distribution_method"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePurchaseOrderAdditionalCostRowRequest:
        """Create an instance of CreatePurchaseOrderAdditionalCostRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePurchaseOrderAdditionalCostRowRequest:
        """Create an instance of CreatePurchaseOrderAdditionalCostRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePurchaseOrderAdditionalCostRowRequest.parse_obj(obj)

        _obj = CreatePurchaseOrderAdditionalCostRowRequest.parse_obj({
