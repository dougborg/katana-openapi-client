...
class UpdateWebhookRequest(BaseModel):
    ...
    __properties = ["url", "enabled", "subscribed_events", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateWebhookRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateWebhookRequest:
        """Create an instance of UpdateWebhookRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateWebhookRequest.parse_obj(obj)

        _obj = UpdateWebhookRequest.parse_obj({
            "url": obj.get("url"),
