...
class StockTransferListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(StockTransfer)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StockTransferListResponse:
        """Create an instance of StockTransferListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StockTransferListResponse:
        """Create an instance of StockTransferListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StockTransferListResponse.parse_obj(obj)

        _obj = StockTransferListResponse.parse_obj({
            "data": [StockTransfer.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
