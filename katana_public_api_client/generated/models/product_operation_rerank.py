...
class ProductOperationRerank(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductOperationRerank:
        """Create an instance of ProductOperationRerank from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductOperationRerank:
        """Create an instance of ProductOperationRerank from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductOperationRerank.parse_obj(obj)

        _obj = ProductOperationRerank.parse_obj(
            {"message": obj.get("message"), "success": obj.get("success")}
        )
        return _obj
