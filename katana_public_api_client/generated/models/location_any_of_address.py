...
class LocationAnyOfAddress(BaseModel):
    """
    ...
    zip: StrictStr = Field(...)
    __properties = ["id", "city", "country", "line_1", "line_2", "state", "zip"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LocationAnyOfAddress:
        """Create an instance of LocationAnyOfAddress from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LocationAnyOfAddress:
        """Create an instance of LocationAnyOfAddress from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LocationAnyOfAddress.parse_obj(obj)

        _obj = LocationAnyOfAddress.parse_obj(
            {
                "id": obj.get("id"),
                "city": obj.get("city"),
