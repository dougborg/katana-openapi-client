...
class AdditionalCostListResponse(BaseModel):
    """
    AdditionalCostListResponse
    """
    data: Optional[conlist(AdditionalCost)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalCostListResponse:
        """Create an instance of AdditionalCostListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalCostListResponse:
        """Create an instance of AdditionalCostListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdditionalCostListResponse.parse_obj(obj)

        _obj = AdditionalCostListResponse.parse_obj({
            "data": [AdditionalCost.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
