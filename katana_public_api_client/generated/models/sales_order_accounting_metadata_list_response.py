...
class SalesOrderAccountingMetadataListResponse(BaseModel):
    """
    SalesOrderAccountingMetadataListResponse
    """

    data: Optional[conlist(SalesOrderAccountingMetadata)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderAccountingMetadataListResponse:
        """Create an instance of SalesOrderAccountingMetadataListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderAccountingMetadataListResponse:
        """Create an instance of SalesOrderAccountingMetadataListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderAccountingMetadataListResponse.parse_obj(obj)

        _obj = SalesOrderAccountingMetadataListResponse.parse_obj(
            {
                "data": [
                    SalesOrderAccountingMetadata.from_dict(_item)
