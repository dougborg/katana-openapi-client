...
class PurchaseOrderAdditionalCostRow(BaseModel):
    ...
    additional_cost_id: StrictInt | None = None
    group_id: StrictInt | None = None
    name: StrictStr | None = None
    distribution_method: StrictStr | None = None
    tax_rate_id: StrictInt | None = None
    tax_rate: StrictFloat | StrictInt | None = None
    price: StrictFloat | StrictInt | None = None
    price_in_base: StrictFloat | StrictInt | None = None
    currency: StrictStr | None = None
    currency_conversion_rate: StrictFloat | StrictInt | None = None
    currency_conversion_rate_fix_date: datetime | None = None
    __properties = [
        "created_at",
        "updated_at",
        "deleted_at",
        ...
        _obj = PurchaseOrderAdditionalCostRow.parse_obj(
            {
                ...
                "currency_conversion_rate_fix_date": obj.get(
                    "currency_conversion_rate_fix_date"
                ),
            }
        )
