...
class PurchaseOrderAdditionalCostRow:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.currency_conversion_rate_fix_date, Unset):
            currency_conversion_rate_fix_date = self.currency_conversion_rate_fix_date.isoformat()
        ...
        if currency_conversion_rate_fix_date is not UNSET:
            field_dict["currency_conversion_rate_fix_date"] = currency_conversion_rate_fix_date
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _currency_conversion_rate_fix_date = d.pop("currency_conversion_rate_fix_date", UNSET)
        ...
        if isinstance(_currency_conversion_rate_fix_date, Unset):
            ...
            currency_conversion_rate_fix_date = isoparse(_currency_conversion_rate_fix_date)
