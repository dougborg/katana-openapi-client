...
class UpdatePurchaseOrderRequest(BaseModel):
    ...
    order_no: Optional[constr(strict=True, min_length=3)] = Field(
        default=None,
        description="Updatable only when status is in NOT_RECEIVED or PARTIALLY_RECEIVED",
    )
    supplier_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None, description="Updatable only when status is in NOT_RECEIVED"
    )
    currency: Optional[StrictStr] = Field(
        default=None, description="Updatable only when status is in NOT_RECEIVED"
    )
    tracking_location_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None,
    ...
    location_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None, description="Updatable only when status is in NOT_RECEIVED"
    )
