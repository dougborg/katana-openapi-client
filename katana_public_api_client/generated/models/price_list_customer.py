...
class PriceListCustomer(BaseModel):
    """
    PriceListCustomer
    """
    ...
    __properties = ["created_at", "updated_at", "id", "price_list_id", "customer_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceListCustomer:
        """Create an instance of PriceListCustomer from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceListCustomer:
        """Create an instance of PriceListCustomer from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceListCustomer.parse_obj(obj)

        _obj = PriceListCustomer.parse_obj(
            {
