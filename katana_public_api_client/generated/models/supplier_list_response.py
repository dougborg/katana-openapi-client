...
class SupplierListResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupplierListResponse:
        """Create an instance of SupplierListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SupplierListResponse:
        """Create an instance of SupplierListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupplierListResponse.parse_obj(obj)

        _obj = SupplierListResponse.parse_obj({
            "data": [Supplier.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
