...
class CodedErrorResponse(BaseModel):
    ...
    status_code: Union[StrictFloat, StrictInt] = Field(
        default=..., alias="statusCode", description="HTTP status code"
    )
    ...
    __properties = ["statusCode", "name", "message", "code"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CodedErrorResponse:
        """Create an instance of CodedErrorResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CodedErrorResponse:
        """Create an instance of CodedErrorResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CodedErrorResponse.parse_obj(obj)

        _obj = CodedErrorResponse.parse_obj(
            {
