...
class ServiceAttributes(BaseModel):
    ...
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of the Service.")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Price of the Service.")
    currency: Optional[StrictStr] = Field(default=None, description="Currency code (e.g., USD).")
    active: Optional[StrictBool] = Field(default=None, description="Indicates if the Service is active.")
    __properties = ["created_at", "updated_at", "name", "description", "price", "currency", "active"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceAttributes:
        """Create an instance of ServiceAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceAttributes:
        """Create an instance of ServiceAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceAttributes.parse_obj(obj)

        _obj = ServiceAttributes.parse_obj({
