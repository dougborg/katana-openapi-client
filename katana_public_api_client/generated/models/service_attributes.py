...
class ServiceAttributes(BaseModel):
    ...
    name: StrictStr | None = Field(default=None, description="Name of the Service.")
    description: StrictStr | None = Field(
        default=None, description="A detailed description of the Service."
    )
    price: StrictFloat | StrictInt | None = Field(
        default=None, description="Price of the Service."
    )
    currency: StrictStr | None = Field(
        default=None, description="Currency code (e.g., USD)."
    )
    active: StrictBool | None = Field(
        default=None, description="Indicates if the Service is active."
    )
    __properties = [
        "created_at",
        "updated_at",
