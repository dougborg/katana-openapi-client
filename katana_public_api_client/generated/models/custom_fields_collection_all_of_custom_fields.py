...
class CustomFieldsCollectionAllOfCustomFields(BaseModel):
    """
    ...
    __properties = ["id", "name", "field_type", "required"]
    ...
    def field_type_validate_enum(cls, value):
        ...
        if value not in ('text', 'number', 'date', 'boolean',):
            raise ValueError("must be one of enum values ('text', 'number', 'date', 'boolean')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldsCollectionAllOfCustomFields:
        """Create an instance of CustomFieldsCollectionAllOfCustomFields from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldsCollectionAllOfCustomFields:
        """Create an instance of CustomFieldsCollectionAllOfCustomFields from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldsCollectionAllOfCustomFields.parse_obj(obj)

        _obj = CustomFieldsCollectionAllOfCustomFields.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
