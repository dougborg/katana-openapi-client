...
class UpdateProductRequestConfigsInner(BaseModel):
    """
    UpdateProductRequestConfigsInner
    """

    name: StrictStr | None = None
    values: conlist(StrictStr) | None = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateProductRequestConfigsInner:
        """Create an instance of UpdateProductRequestConfigsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateProductRequestConfigsInner:
        """Create an instance of UpdateProductRequestConfigsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateProductRequestConfigsInner.parse_obj(obj)

        _obj = UpdateProductRequestConfigsInner.parse_obj(
            {"name": obj.get("name"), "values": obj.get("values")}
        )
        return _obj
