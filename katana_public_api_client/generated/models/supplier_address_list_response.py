...
class SupplierAddressListResponse(BaseModel):
    """
    SupplierAddressListResponse
    """
    data: Optional[conlist(SupplierAddress)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SupplierAddressListResponse:
        """Create an instance of SupplierAddressListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SupplierAddressListResponse:
        """Create an instance of SupplierAddressListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SupplierAddressListResponse.parse_obj(obj)

        _obj = SupplierAddressListResponse.parse_obj({
            "data": [SupplierAddress.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
