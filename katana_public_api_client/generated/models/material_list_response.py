...
class MaterialListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(Material)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaterialListResponse:
        """Create an instance of MaterialListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaterialListResponse:
        """Create an instance of MaterialListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MaterialListResponse.parse_obj(obj)

        _obj = MaterialListResponse.parse_obj({
            "data": [Material.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
