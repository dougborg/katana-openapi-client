...
class ManufacturingOrderRecipeRow(BaseModel):
    """
    ...
    planned_quantity_per_unit: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "manufacturing_order_id", "variant_id", "notes", "planned_quantity_per_unit", "total_actual_quantity", "ingredient_availability", "ingredient_expected_date", "batch_transactions", "cost"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderRecipeRow:
        """Create an instance of ManufacturingOrderRecipeRow from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderRecipeRow:
        """Create an instance of ManufacturingOrderRecipeRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderRecipeRow.parse_obj(obj)

        _obj = ManufacturingOrderRecipeRow.parse_obj({
