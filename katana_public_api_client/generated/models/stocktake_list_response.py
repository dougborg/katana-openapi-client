...
class StocktakeListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(Stocktake)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StocktakeListResponse:
        """Create an instance of StocktakeListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StocktakeListResponse:
        """Create an instance of StocktakeListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StocktakeListResponse.parse_obj(obj)

        _obj = StocktakeListResponse.parse_obj({
            "data": [Stocktake.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
