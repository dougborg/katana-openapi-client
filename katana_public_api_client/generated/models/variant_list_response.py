...
class VariantListResponse(BaseModel):
    ...
    VariantListResponse
    """
    data: Optional[conlist(VariantResponse)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariantListResponse:
        """Create an instance of VariantListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariantListResponse:
        """Create an instance of VariantListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariantListResponse.parse_obj(obj)

        _obj = VariantListResponse.parse_obj({
            "data": [VariantResponse.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
