...
class PurchaseOrderRowListResponse(BaseModel):
    """
    PurchaseOrderRowListResponse
    """
    data: Optional[conlist(PurchaseOrderRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderRowListResponse:
        """Create an instance of PurchaseOrderRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderRowListResponse:
        """Create an instance of PurchaseOrderRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderRowListResponse.parse_obj(obj)

        _obj = PurchaseOrderRowListResponse.parse_obj({
            "data": [PurchaseOrderRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
