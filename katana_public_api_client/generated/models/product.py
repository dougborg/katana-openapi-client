...
if TYPE_CHECKING:
    ...
    from ..models.product_variants_item import ProductVariantsItem
...
class Product:
    ...
    Attributes:
        ...
        variants (Union[Unset, list['ProductVariantsItem']]):
        configs (Union[Unset, list['ProductConfigsItem']]):
        custom_field_collection_id (Union[Unset, int]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        archived_at (Union[None, Unset, datetime.datetime]):
        supplier (Union[Unset, ProductSupplier]):
    """
    ...
    variants: Unset | list["ProductVariantsItem"] = UNSET
    ...
    supplier: Union[Unset, "ProductSupplier"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in _variants or []:
            variants_item = ProductVariantsItem.from_dict(variants_item_data)
        ...
        supplier: Unset | ProductSupplier
        if isinstance(_supplier, Unset):
            supplier = UNSET
        else:
            supplier = ProductSupplier.from_dict(_supplier)
