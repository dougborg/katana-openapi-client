...
class Product(BaseModel):
    ...
    archived_at: StrictStr | None = Field(
        default=None, description="Nullable archive timestamp"
    )
    ...
    configs: conlist(MaterialAllOfConfigs) | None = None
    custom_field_collection_id: StrictInt | None = None
        ...
        _obj = Product.parse_obj(
            {
                ...
                "configs": [
                    MaterialAllOfConfigs.from_dict(_item)
