...
class PurchaseOrderRowAllOfLandedCost(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        actual_instance: Any
    any_of_schemas: List[str] = Field(PURCHASEORDERROWALLOFLANDEDCOST_ANY_OF_SCHEMAS, const=True)
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in PurchaseOrderRowAllOfLandedCost with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> PurchaseOrderRowAllOfLandedCost:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into PurchaseOrderRowAllOfLandedCost with anyOf schemas: float, str. Details: " + ", ".join(error_messages))
        else:
            return instance
