...
class BomRow(BaseModel):
    ...
    product_item_id: StrictInt = Field(...)
    ingredient_variant_id: StrictInt = Field(...)
    quantity: Union[StrictFloat, StrictInt] = Field(...)
    notes: Optional[StrictStr] = None
    __properties = ["created_at", "updated_at", "id", "product_variant_id", "product_item_id", "ingredient_variant_id", "quantity", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BomRow:
        """Create an instance of BomRow from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BomRow:
        """Create an instance of BomRow from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BomRow.parse_obj(obj)

        _obj = BomRow.parse_obj({
            "created_at": obj.get("created_at"),
            "updated_at": obj.get("updated_at"),
            "id": obj.get("id"),
            "product_variant_id": obj.get("product_variant_id"),
            "product_item_id": obj.get("product_item_id"),
