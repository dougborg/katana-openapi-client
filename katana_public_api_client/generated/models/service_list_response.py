...
class ServiceListResponse(BaseModel):
    ...
    ServiceListResponse
    """
    data: Optional[conlist(Service)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceListResponse:
        """Create an instance of ServiceListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceListResponse.parse_obj(obj)

        _obj = ServiceListResponse.parse_obj({
            "data": [Service.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
