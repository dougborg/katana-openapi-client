...
class UpdateSupplierRequest(BaseModel):
    ...
    currency: Optional[StrictStr] = Field(default=None, description="The supplier's currency (ISO 4217).")
    comment: Optional[StrictStr] = None
    __properties = ["name", "email", "phone", "currency", "comment"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateSupplierRequest:
        """Create an instance of UpdateSupplierRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateSupplierRequest:
        """Create an instance of UpdateSupplierRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateSupplierRequest.parse_obj(obj)

        _obj = UpdateSupplierRequest.parse_obj({
            "name": obj.get("name"),
            "email": obj.get("email"),
            "phone": obj.get("phone"),
