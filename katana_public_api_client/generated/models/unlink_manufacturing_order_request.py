...
class UnlinkManufacturingOrderRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnlinkManufacturingOrderRequest:
        """Create an instance of UnlinkManufacturingOrderRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnlinkManufacturingOrderRequest:
        """Create an instance of UnlinkManufacturingOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnlinkManufacturingOrderRequest.parse_obj(obj)

        _obj = UnlinkManufacturingOrderRequest.parse_obj(
