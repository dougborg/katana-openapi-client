...
class AdditionalCost(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdditionalCost:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdditionalCost:
        """Create an instance of AdditionalCost from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AdditionalCost.parse_obj(obj)

        _obj = AdditionalCost.parse_obj({
