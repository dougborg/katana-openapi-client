...
class UpdateManufacturingOrderRequest:
    """Request object for updating an existing manufacturing order

    Example:
        {'planned_quantity': 2, 'additional_info': 'Updated production requirements', 'production_deadline_date':
