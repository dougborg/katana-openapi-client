...
class UpdateManufacturingOrderRequest(BaseModel):
    """
    ...
    __properties = ["planned_quantity", "additional_info", "production_deadline_date"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateManufacturingOrderRequest:
        """Create an instance of UpdateManufacturingOrderRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateManufacturingOrderRequest:
        """Create an instance of UpdateManufacturingOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateManufacturingOrderRequest.parse_obj(obj)

        _obj = UpdateManufacturingOrderRequest.parse_obj(
            {
