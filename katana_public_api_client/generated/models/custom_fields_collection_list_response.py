...
class CustomFieldsCollectionListResponse(BaseModel):
    """
    CustomFieldsCollectionListResponse
    """

    data: Optional[conlist(CustomFieldsCollection)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomFieldsCollectionListResponse:
        """Create an instance of CustomFieldsCollectionListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomFieldsCollectionListResponse:
        """Create an instance of CustomFieldsCollectionListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomFieldsCollectionListResponse.parse_obj(obj)

        _obj = CustomFieldsCollectionListResponse.parse_obj(
            {
                "data": [
                    CustomFieldsCollection.from_dict(_item) for _item in obj.get("data")
                ]
