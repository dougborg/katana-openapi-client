...
class CreateManufacturingOrderOperationRowRequest(BaseModel):
    """
    CreateManufacturingOrderOperationRowRequest
    """

    manufacturing_order_id: StrictInt = Field(...)
    operation_id: StrictInt = Field(...)
    time: StrictFloat | StrictInt = Field(...)
    __properties = ["manufacturing_order_id", "operation_id", "time"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateManufacturingOrderOperationRowRequest:
        """Create an instance of CreateManufacturingOrderOperationRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateManufacturingOrderOperationRowRequest:
        """Create an instance of CreateManufacturingOrderOperationRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateManufacturingOrderOperationRowRequest.parse_obj(obj)

        _obj = CreateManufacturingOrderOperationRowRequest.parse_obj(
            {
