...
class PurchaseOrderAccountingMetadata(BaseModel):
    ...
    purchase_order_id: StrictInt | None = None
    purchase_order_id: StrictInt | None = Field(default=None, alias="purchaseOrderId")
    por_received_group_id: StrictInt | None = Field(
        default=None, alias="porReceivedGroupId"
    )
    integration_type: StrictStr | None = Field(default=None, alias="integrationType")
    bill_id: StrictStr | None = Field(default=None, alias="billId")
