...
if TYPE_CHECKING:
    from ..models.product_variants_item_config_attributes_item import (
        ProductVariantsItemConfigAttributesItem,
    )
    from ..models.product_variants_item_custom_fields_item import (
        ProductVariantsItemCustomFieldsItem,
    )


T = TypeVar("T", bound="ProductVariantsItem")


@_attrs_define
class ProductVariantsItem:
    """
    Attributes:
        id (Union[Unset, int]):
        sku (Union[Unset, str]):
        ...
        config_attributes (Union[Unset, list['ProductVariantsItemConfigAttributesItem']]):
        ...
        custom_fields (Union[Unset, list['ProductVariantsItemCustomFieldsItem']]):
    """
    ...
    config_attributes: Unset | list["ProductVariantsItemConfigAttributesItem"] = UNSET
    internal_barcode: Unset | str = UNSET
    registered_barcode: Unset | str = UNSET
    supplier_item_codes: Unset | list[str] = UNSET
    lead_time: None | Unset | float = UNSET
    minimum_order_quantity: Unset | float = UNSET
    custom_fields: Unset | list["ProductVariantsItemCustomFieldsItem"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for config_attributes_item_data in _config_attributes or []:
            config_attributes_item = ProductVariantsItemConfigAttributesItem.from_dict(
        ...
        def _parse_lead_time(data: object) -> None | Unset | float:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        for custom_fields_item_data in _custom_fields or []:
            custom_fields_item = ProductVariantsItemCustomFieldsItem.from_dict(
                custom_fields_item_data
            )

            custom_fields.append(custom_fields_item)

        product_variants_item = cls(
            id=id,
            sku=sku,
        ...
        product_variants_item.additional_properties = d
        return product_variants_item
