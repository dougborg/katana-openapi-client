...
class ManufacturingOrderOperationProduction:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if manufacturing_order_operation_id is not UNSET:
            field_dict["manufacturing_order_operation_id"] = manufacturing_order_operation_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        manufacturing_order_operation_id = d.pop("manufacturing_order_operation_id", UNSET)
