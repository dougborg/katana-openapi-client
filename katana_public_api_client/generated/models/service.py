...
class Service(BaseModel):
    ...
    Service
    """
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the Service.")
    type: Optional[StrictStr] = Field(default=None, description="Resource type - always 'services'.")
    ...
    def from_dict(cls, obj: dict) -> Service:
        ...
        _obj = Service.parse_obj({
            "id": obj.get("id"),
            "type": obj.get("type"),
            "attributes": ServiceAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
