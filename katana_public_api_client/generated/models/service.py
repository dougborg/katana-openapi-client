...
class Service(BaseModel):
    ...
    id: StrictStr | None = Field(
        default=None, description="Unique identifier of the Service."
    )
    type: StrictStr | None = Field(
        default=None, description="Resource type - always 'services'."
    )
    attributes: ServiceAttributes | None = None
    __properties = ["id", "type", "attributes"]
        ...
        _obj = Service.parse_obj(
            {
                "id": obj.get("id"),
                "type": obj.get("type"),
                "attributes": ServiceAttributes.from_dict(obj.get("attributes"))
