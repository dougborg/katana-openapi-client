...
class BomRowListResponse(BaseModel):
    """
    BomRowListResponse
    """
    data: Optional[conlist(BomRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BomRowListResponse:
        """Create an instance of BomRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BomRowListResponse:
        """Create an instance of BomRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BomRowListResponse.parse_obj(obj)

        _obj = BomRowListResponse.parse_obj({
            "data": [BomRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
