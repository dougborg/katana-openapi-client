...
class NegativeStockListResponse(BaseModel):
    """
    NegativeStockListResponse
    """
    data: Optional[conlist(NegativeStock)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> NegativeStockListResponse:
        """Create an instance of NegativeStockListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> NegativeStockListResponse:
        """Create an instance of NegativeStockListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return NegativeStockListResponse.parse_obj(obj)

        _obj = NegativeStockListResponse.parse_obj({
            "data": [NegativeStock.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
