...
class PurchaseOrderReceiveRow(BaseModel):
    ...
    received_date: Optional[StrictStr] = Field(default=None, description="Optional received date in ISO 8601 format.")
    batch_transactions: Optional[conlist(PurchaseOrderReceiveRowBatchTransactionsInner)] = None
    additional_properties: Dict[str, Any] = {}
    __properties = ["purchase_order_row_id", "quantity", "received_date", "batch_transactions"]
    ...
    def from_dict(cls, obj: dict) -> PurchaseOrderReceiveRow:
        ...
        _obj = PurchaseOrderReceiveRow.parse_obj({
            ...
            "batch_transactions": [PurchaseOrderReceiveRowBatchTransactionsInner.from_dict(_item) for _item in obj.get("batch_transactions")] if obj.get("batch_transactions") is not None else None
        })
