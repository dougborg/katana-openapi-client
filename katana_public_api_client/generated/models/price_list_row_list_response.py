...
class PriceListRowListResponse(BaseModel):
    """
    PriceListRowListResponse
    """
    data: Optional[conlist(PriceListRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceListRowListResponse:
        """Create an instance of PriceListRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceListRowListResponse:
        """Create an instance of PriceListRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceListRowListResponse.parse_obj(obj)

        _obj = PriceListRowListResponse.parse_obj({
            "data": [PriceListRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
