...
class UpdateManufacturingOrderProductionRequest(BaseModel):
    ...
    ingredients: Optional[conlist(UpdateManufacturingOrderProductionIngredientRequest)] = None
    operations: Optional[conlist(UpdateManufacturingOrderOperationRowRequest)] = None
    ...
    def from_dict(cls, obj: dict) -> UpdateManufacturingOrderProductionRequest:
        ...
        _obj = UpdateManufacturingOrderProductionRequest.parse_obj({
            ...
            "ingredients": [UpdateManufacturingOrderProductionIngredientRequest.from_dict(_item) for _item in obj.get("ingredients")] if obj.get("ingredients") is not None else None,
            "operations": [UpdateManufacturingOrderOperationRowRequest.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
