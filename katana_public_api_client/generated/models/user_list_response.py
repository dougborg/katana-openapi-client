...
class UserListResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UserListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UserListResponse:
        """Create an instance of UserListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UserListResponse.parse_obj(obj)

        _obj = UserListResponse.parse_obj(
            {
