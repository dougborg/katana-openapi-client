...
if TYPE_CHECKING:
    from ..models.purchase_order_row_batch_transactions_item import PurchaseOrderRowBatchTransactionsItem
...
class PurchaseOrderRow:
    ...
    batch_transactions: Union[Unset, list["PurchaseOrderRowBatchTransactionsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for batch_transactions_item_data in _batch_transactions or []:
            batch_transactions_item = PurchaseOrderRowBatchTransactionsItem.from_dict(batch_transactions_item_data)
