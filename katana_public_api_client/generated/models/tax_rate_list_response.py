...
class TaxRateListResponse(BaseModel):
    ...
    TaxRateListResponse
    """
    data: Optional[conlist(TaxRate)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxRateListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxRateListResponse:
        """Create an instance of TaxRateListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxRateListResponse.parse_obj(obj)

        _obj = TaxRateListResponse.parse_obj({
            "data": [TaxRate.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
