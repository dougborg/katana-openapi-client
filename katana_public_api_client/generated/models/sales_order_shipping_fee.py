...
class SalesOrderShippingFee(BaseModel):
    """
    ...
    __properties = ["id", "sales_order_id", "amount", "tax_rate_id", "description"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderShippingFee:
        """Create an instance of SalesOrderShippingFee from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderShippingFee:
        """Create an instance of SalesOrderShippingFee from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderShippingFee.parse_obj(obj)

        _obj = SalesOrderShippingFee.parse_obj({
            "id": obj.get("id"),
