...
class PurchaseOrderReceiveRowBatchTransactionsInner(BaseModel):
    """
    PurchaseOrderReceiveRowBatchTransactionsInner
    """

    batch_id: StrictInt = Field(...)
    quantity: confloat(le=100000000000000000, strict=True) | conint(
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderReceiveRowBatchTransactionsInner:
        """Create an instance of PurchaseOrderReceiveRowBatchTransactionsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderReceiveRowBatchTransactionsInner:
        """Create an instance of PurchaseOrderReceiveRowBatchTransactionsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderReceiveRowBatchTransactionsInner.parse_obj(obj)

        _obj = PurchaseOrderReceiveRowBatchTransactionsInner.parse_obj(
            {"batch_id": obj.get("batch_id"), "quantity": obj.get("quantity")}
        )
        return _obj
