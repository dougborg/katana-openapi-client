...
class StorageBin(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "name", "location_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StorageBin:
        """Create an instance of StorageBin from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StorageBin:
        """Create an instance of StorageBin from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StorageBin.parse_obj(obj)

        _obj = StorageBin.parse_obj({
