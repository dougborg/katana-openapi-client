...
class ProductOperationRerankRequest(BaseModel):
    """
    ProductOperationRerankRequest
    """
    rank_product_operation_id: StrictInt = Field(...)
    preceeding_product_operation_id: Optional[StrictInt] = None
    should_group: Optional[StrictBool] = None
    __properties = ["rank_product_operation_id", "preceeding_product_operation_id", "should_group"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProductOperationRerankRequest:
        """Create an instance of ProductOperationRerankRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProductOperationRerankRequest:
        """Create an instance of ProductOperationRerankRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ProductOperationRerankRequest.parse_obj(obj)

        _obj = ProductOperationRerankRequest.parse_obj({
            "rank_product_operation_id": obj.get("rank_product_operation_id"),
            "preceeding_product_operation_id": obj.get("preceeding_product_operation_id"),
            "should_group": obj.get("should_group")
        })
        return _obj
