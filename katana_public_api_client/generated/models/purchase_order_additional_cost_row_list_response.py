...
class PurchaseOrderAdditionalCostRowListResponse(BaseModel):
    """
    PurchaseOrderAdditionalCostRowListResponse
    """
    data: Optional[conlist(PurchaseOrderAdditionalCostRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderAdditionalCostRowListResponse:
        """Create an instance of PurchaseOrderAdditionalCostRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderAdditionalCostRowListResponse:
        """Create an instance of PurchaseOrderAdditionalCostRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderAdditionalCostRowListResponse.parse_obj(obj)

        _obj = PurchaseOrderAdditionalCostRowListResponse.parse_obj({
            "data": [PurchaseOrderAdditionalCostRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
