...
class MaterialAllOfConfigs(BaseModel):
    """
    ...
    __properties = ["id", "name", "values", "product_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MaterialAllOfConfigs:
        """Create an instance of MaterialAllOfConfigs from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MaterialAllOfConfigs:
        """Create an instance of MaterialAllOfConfigs from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MaterialAllOfConfigs.parse_obj(obj)

        _obj = MaterialAllOfConfigs.parse_obj(
            {
                "id": obj.get("id"),
                "name": obj.get("name"),
