...
class PriceListCustomerListResponse(BaseModel):
    """
    PriceListCustomerListResponse
    """

    data: Optional[conlist(PriceListCustomer)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PriceListCustomerListResponse:
        """Create an instance of PriceListCustomerListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PriceListCustomerListResponse:
        """Create an instance of PriceListCustomerListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PriceListCustomerListResponse.parse_obj(obj)

        _obj = PriceListCustomerListResponse.parse_obj(
            {
                "data": [
                    PriceListCustomer.from_dict(_item) for _item in obj.get("data")
                ]
