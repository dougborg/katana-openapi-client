...
class SalesOrderRowAllOfAttributes(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderRowAllOfAttributes:
        """Create an instance of SalesOrderRowAllOfAttributes from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderRowAllOfAttributes:
        """Create an instance of SalesOrderRowAllOfAttributes from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderRowAllOfAttributes.parse_obj(obj)

        _obj = SalesOrderRowAllOfAttributes.parse_obj(
