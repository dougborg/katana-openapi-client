...
class CreateMaterialRequest(BaseModel):
    ...
    __properties = ["name", "uom", "category_name", "default_supplier_id", "additional_info", "batch_tracked", "is_sellable", "purchase_uom", "purchase_uom_conversion_rate", "configs", "variants"]
    ...
    def from_dict(cls, obj: dict) -> CreateMaterialRequest:
        ...
        _obj = CreateMaterialRequest.parse_obj({
            ...
            "configs": [CreateMaterialRequestConfigsInner.from_dict(_item) for _item in obj.get("configs")] if obj.get("configs") is not None else None,
