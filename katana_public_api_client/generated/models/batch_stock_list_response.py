...
class BatchStockListResponse(BaseModel):
    """
    BatchStockListResponse
    """
    data: Optional[conlist(BatchStock)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchStockListResponse:
        """Create an instance of BatchStockListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchStockListResponse:
        """Create an instance of BatchStockListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchStockListResponse.parse_obj(obj)

        _obj = BatchStockListResponse.parse_obj({
            "data": [BatchStock.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
