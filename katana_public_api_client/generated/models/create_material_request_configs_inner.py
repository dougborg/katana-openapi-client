...
class CreateMaterialRequestConfigsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateMaterialRequestConfigsInner:
        """Create an instance of CreateMaterialRequestConfigsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateMaterialRequestConfigsInner:
        """Create an instance of CreateMaterialRequestConfigsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateMaterialRequestConfigsInner.parse_obj(obj)

        _obj = CreateMaterialRequestConfigsInner.parse_obj(
