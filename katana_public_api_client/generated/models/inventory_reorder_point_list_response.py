...
class InventoryReorderPointListResponse(BaseModel):
    """
    InventoryReorderPointListResponse
    """

    data: Optional[conlist(InventoryReorderPoint)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryReorderPointListResponse:
        """Create an instance of InventoryReorderPointListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryReorderPointListResponse:
        """Create an instance of InventoryReorderPointListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryReorderPointListResponse.parse_obj(obj)

        _obj = InventoryReorderPointListResponse.parse_obj(
            {
                "data": [
                    InventoryReorderPoint.from_dict(_item) for _item in obj.get("data")
                ]
