...
class ManufacturingOrderOperationRowResponse(BaseModel):
    ...
    __properties = ["id", "status", "type", "rank", "manufacturing_order_id", "operation_id", "operation_name", "resource_id", "resource_name", "assigned_operators", "completed_by_operators", "active_operator_id", "planned_time_per_unit", "planned_time_parameter", "total_actual_time", "planned_cost_per_unit", "total_actual_cost", "cost_per_hour", "cost_parameter", "group_boundary", "is_status_actionable", "completed_at", "created_at", "updated_at", "deleted_at"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('IN_PROGRESS', 'COMPLETED', 'PAUSED',):
            raise ValueError("must be one of enum values ('IN_PROGRESS', 'COMPLETED', 'PAUSED')")
        return value
    ...
    def from_dict(cls, obj: dict) -> ManufacturingOrderOperationRowResponse:
        ...
        _obj = ManufacturingOrderOperationRowResponse.parse_obj({
            ...
            "assigned_operators": [Operator.from_dict(_item) for _item in obj.get("assigned_operators")] if obj.get("assigned_operators") is not None else None,
            "completed_by_operators": [Operator.from_dict(_item) for _item in obj.get("completed_by_operators")] if obj.get("completed_by_operators") is not None else None,
