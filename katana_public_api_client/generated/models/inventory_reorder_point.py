...
class InventoryReorderPoint(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryReorderPoint:
        """Create an instance of InventoryReorderPoint from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryReorderPoint:
        """Create an instance of InventoryReorderPoint from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryReorderPoint.parse_obj(obj)

        _obj = InventoryReorderPoint.parse_obj({
