...
class ManufacturingOrderProductionIngredient(BaseModel):
    """
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "location_id", "variant_id", "manufacturing_order_id", "manufacturing_order_recipe_row_id", "production_id", "quantity", "production_date", "cost"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderProductionIngredient:
        """Create an instance of ManufacturingOrderProductionIngredient from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderProductionIngredient:
        """Create an instance of ManufacturingOrderProductionIngredient from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderProductionIngredient.parse_obj(obj)

        _obj = ManufacturingOrderProductionIngredient.parse_obj({
