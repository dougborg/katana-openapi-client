...
from ..models.sales_order_row_product_availability_type_0 import SalesOrderRowProductAvailabilityType0
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.sales_order_row_attributes_item import SalesOrderRowAttributesItem
    from ..models.sales_order_row_batch_transactions_item import SalesOrderRowBatchTransactionsItem
...
class SalesOrderRow:
    ...
    product_availability: Union[None, SalesOrderRowProductAvailabilityType0, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        elif isinstance(self.product_availability, SalesOrderRowProductAvailabilityType0):
        ...
        if price_per_unit_in_base_currency is not UNSET:
            field_dict["price_per_unit_in_base_currency"] = price_per_unit_in_base_currency
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_product_availability(data: object) -> Union[None, SalesOrderRowProductAvailabilityType0, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                product_availability_type_0 = SalesOrderRowProductAvailabilityType0(data)
        ...
        price_per_unit_in_base_currency = d.pop("price_per_unit_in_base_currency", UNSET)
        ...
        for attributes_item_data in _attributes or []:
            attributes_item = SalesOrderRowAttributesItem.from_dict(attributes_item_data)
        ...
        for batch_transactions_item_data in _batch_transactions or []:
            batch_transactions_item = SalesOrderRowBatchTransactionsItem.from_dict(batch_transactions_item_data)

            batch_transactions.append(batch_transactions_item)

        serial_numbers = cast(list[int], d.pop("serial_numbers", UNSET))

        def _parse_linked_manufacturing_order_id(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
