...
class Customer(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "name", "first_name", "last_name", "company", "email", "phone", "comment", "currency", "reference_id", "category", "discount_rate", "default_billing_id", "default_shipping_id"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.default_billing_id is None and "default_billing_id" in self.__fields_set__:
            _dict['default_billing_id'] = None

        # set to None if default_shipping_id (nullable) is None
        # and __fields_set__ contains the field
        if self.default_shipping_id is None and "default_shipping_id" in self.__fields_set__:
