...
class OutsourcedPurchaseOrderRecipeRowListResponse(BaseModel):
    """
    OutsourcedPurchaseOrderRecipeRowListResponse
    """

    data: Optional[conlist(OutsourcedPurchaseOrderRecipeRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OutsourcedPurchaseOrderRecipeRowListResponse:
        """Create an instance of OutsourcedPurchaseOrderRecipeRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OutsourcedPurchaseOrderRecipeRowListResponse:
        """Create an instance of OutsourcedPurchaseOrderRecipeRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OutsourcedPurchaseOrderRecipeRowListResponse.parse_obj(obj)

        _obj = OutsourcedPurchaseOrderRecipeRowListResponse.parse_obj(
            {
                "data": [
                    OutsourcedPurchaseOrderRecipeRow.from_dict(_item)
