...
class ServiceRequestData(BaseModel):
    ...
    ServiceRequestData
    """
    type: StrictStr = Field(default=..., description="Resource type must be 'services'.")
    ...
    def from_dict(cls, obj: dict) -> ServiceRequestData:
        ...
        _obj = ServiceRequestData.parse_obj({
            "type": obj.get("type"),
            "attributes": ServiceInputAttributes.from_dict(obj.get("attributes")) if obj.get("attributes") is not None else None
        })
        return _obj
