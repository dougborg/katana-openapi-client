...
class CreateTaxRateRequest(BaseModel):
    ...
    rate: confloat(le=999.999, ge=0, multiple_of=0.001, strict=True) | conint(
        le=999, ge=0, strict=True
    ) = Field(...)
    __properties = ["name", "rate"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateTaxRateRequest:
        """Create an instance of CreateTaxRateRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateTaxRateRequest:
        """Create an instance of CreateTaxRateRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateTaxRateRequest.parse_obj(obj)

        _obj = CreateTaxRateRequest.parse_obj(
            {"name": obj.get("name"), "rate": obj.get("rate")}
        )
        return _obj
