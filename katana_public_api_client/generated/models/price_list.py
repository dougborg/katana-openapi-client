...
class PriceList(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "name", "currency", "is_default", "markup_percentage", "start_date", "end_date"]
    ...
    def to_dict(self):
        ...
        if self.markup_percentage is None and "markup_percentage" in self.__fields_set__:
