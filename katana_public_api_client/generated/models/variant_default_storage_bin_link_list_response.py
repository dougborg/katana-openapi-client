...
class VariantDefaultStorageBinLinkListResponse(BaseModel):
    """
    VariantDefaultStorageBinLinkListResponse
    """

    data: Optional[conlist(VariantDefaultStorageBinLinkResponse)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariantDefaultStorageBinLinkListResponse:
        """Create an instance of VariantDefaultStorageBinLinkListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariantDefaultStorageBinLinkListResponse:
        """Create an instance of VariantDefaultStorageBinLinkListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariantDefaultStorageBinLinkListResponse.parse_obj(obj)

        _obj = VariantDefaultStorageBinLinkListResponse.parse_obj(
            {
                "data": [
                    VariantDefaultStorageBinLinkResponse.from_dict(_item)
