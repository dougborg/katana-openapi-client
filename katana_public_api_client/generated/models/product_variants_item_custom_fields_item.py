...
T = TypeVar("T", bound="ProductVariantsItemCustomFieldsItem")


@_attrs_define
class ProductVariantsItemCustomFieldsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_variants_item_custom_fields_item = cls(
            field_name=field_name,
            field_value=field_value,
        )

        product_variants_item_custom_fields_item.additional_properties = d
        return product_variants_item_custom_fields_item
