...
class ManufacturingOrderOperationRowListResponse(BaseModel):
    """
    ManufacturingOrderOperationRowListResponse
    """

    data: Optional[conlist(ManufacturingOrderOperationRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderOperationRowListResponse:
        """Create an instance of ManufacturingOrderOperationRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderOperationRowListResponse:
        """Create an instance of ManufacturingOrderOperationRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderOperationRowListResponse.parse_obj(obj)

        _obj = ManufacturingOrderOperationRowListResponse.parse_obj(
            {
                "data": [
