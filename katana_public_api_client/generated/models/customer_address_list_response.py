...
class CustomerAddressListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(CustomerAddress)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CustomerAddressListResponse:
        """Create an instance of CustomerAddressListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CustomerAddressListResponse:
        """Create an instance of CustomerAddressListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CustomerAddressListResponse.parse_obj(obj)

        _obj = CustomerAddressListResponse.parse_obj({
            "data": [CustomerAddress.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
