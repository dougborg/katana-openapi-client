...
class SalesOrderRowListResponse(BaseModel):
    """
    SalesOrderRowListResponse
    """
    data: Optional[conlist(SalesOrderRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderRowListResponse:
        """Create an instance of SalesOrderRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderRowListResponse:
        """Create an instance of SalesOrderRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderRowListResponse.parse_obj(obj)

        _obj = SalesOrderRowListResponse.parse_obj({
            "data": [SalesOrderRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
