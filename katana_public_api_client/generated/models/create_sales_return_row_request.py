...
class CreateSalesReturnRowRequest(BaseModel):
    ...
    variant_id: StrictInt = Field(
        default=..., description="ID of the variant being returned"
    )
    quantity: Union[StrictFloat, StrictInt] = Field(
        default=..., description="Quantity being returned"
    )
    return_reason_id: Optional[StrictInt] = Field(
        default=None, description="ID of the return reason"
    )
    notes: Optional[StrictStr] = Field(
        default=None, description="Optional notes about this returned item"
    )
