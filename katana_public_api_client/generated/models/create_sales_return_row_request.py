...
class CreateSalesReturnRowRequest(BaseModel):
    """
    CreateSalesReturnRowRequest
    """
    variant_id: StrictInt = Field(default=..., description="ID of the variant being returned")
    quantity: Union[StrictFloat, StrictInt] = Field(default=..., description="Quantity being returned")
    return_reason_id: Optional[StrictInt] = Field(default=None, description="ID of the return reason")
    notes: Optional[StrictStr] = Field(default=None, description="Optional notes about this returned item")
    __properties = ["variant_id", "quantity", "return_reason_id", "notes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSalesReturnRowRequest:
        """Create an instance of CreateSalesReturnRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSalesReturnRowRequest:
        """Create an instance of CreateSalesReturnRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSalesReturnRowRequest.parse_obj(obj)

        _obj = CreateSalesReturnRowRequest.parse_obj({
