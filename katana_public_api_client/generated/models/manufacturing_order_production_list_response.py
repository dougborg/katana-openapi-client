...
class ManufacturingOrderProductionListResponse(BaseModel):
    """
    ManufacturingOrderProductionListResponse
    """

    data: Optional[conlist(ManufacturingOrderProduction)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderProductionListResponse:
        """Create an instance of ManufacturingOrderProductionListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderProductionListResponse:
        """Create an instance of ManufacturingOrderProductionListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderProductionListResponse.parse_obj(obj)

        _obj = ManufacturingOrderProductionListResponse.parse_obj(
            {
                "data": [
                    ManufacturingOrderProduction.from_dict(_item)
