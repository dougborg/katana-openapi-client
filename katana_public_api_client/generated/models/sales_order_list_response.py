...
class SalesOrderListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(SalesOrder)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesOrderListResponse:
        """Create an instance of SalesOrderListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesOrderListResponse:
        """Create an instance of SalesOrderListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesOrderListResponse.parse_obj(obj)

        _obj = SalesOrderListResponse.parse_obj({
            "data": [SalesOrder.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
