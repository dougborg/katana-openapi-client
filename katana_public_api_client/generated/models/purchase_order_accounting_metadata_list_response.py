...
class PurchaseOrderAccountingMetadataListResponse(BaseModel):
    """
    PurchaseOrderAccountingMetadataListResponse
    """

    data: Optional[conlist(PurchaseOrderAccountingMetadata)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderAccountingMetadataListResponse:
        """Create an instance of PurchaseOrderAccountingMetadataListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderAccountingMetadataListResponse:
        """Create an instance of PurchaseOrderAccountingMetadataListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderAccountingMetadataListResponse.parse_obj(obj)

        _obj = PurchaseOrderAccountingMetadataListResponse.parse_obj(
            {
                "data": [
                    PurchaseOrderAccountingMetadata.from_dict(_item)
