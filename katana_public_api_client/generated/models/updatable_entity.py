...
class UpdatableEntity(BaseModel):
    """
    Common fields for entities that can be updated  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdatableEntity:
        """Create an instance of UpdatableEntity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdatableEntity:
        """Create an instance of UpdatableEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdatableEntity.parse_obj(obj)

        _obj = UpdatableEntity.parse_obj(
