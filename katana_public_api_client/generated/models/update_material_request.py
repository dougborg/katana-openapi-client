...
class UpdateMaterialRequest(BaseModel):
    ...
    purchase_uom: constr(strict=True, max_length=7) | None = Field(
        default=None,
    ...
    configs: conlist(UpdateMaterialRequestConfigsInner, min_items=1) | None = Field(
        default=None,
        description="When updating configs, all configs and values must be provided. Existing ones are matched,         new ones are created, and configs not provided in the update are deleted.",
    )
        ...
        _obj = UpdateMaterialRequest.parse_obj(
            {
                ...
                "configs": [
                    UpdateMaterialRequestConfigsInner.from_dict(_item)
