...
class CreateSupplierAddressRequest(BaseModel):
    """
    CreateSupplierAddressRequest
    """
    supplier_id: StrictInt = Field(...)
    line_1: StrictStr = Field(...)
    line_2: Optional[StrictStr] = None
    city: Optional[StrictStr] = None
    state: Optional[StrictStr] = None
    zip: Optional[StrictStr] = None
    country: Optional[StrictStr] = None
    __properties = ["supplier_id", "line_1", "line_2", "city", "state", "zip", "country"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSupplierAddressRequest:
        """Create an instance of CreateSupplierAddressRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSupplierAddressRequest:
        """Create an instance of CreateSupplierAddressRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSupplierAddressRequest.parse_obj(obj)

        _obj = CreateSupplierAddressRequest.parse_obj({
