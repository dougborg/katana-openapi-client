...
class LocationAnyOf(BaseModel):
    ...
    address_id: StrictInt | None = None
    address: LocationAnyOfAddress | None = None
    is_primary: StrictBool | None = None
    sales_allowed: StrictBool | None = None
    purchase_allowed: StrictBool | None = None
    manufacturing_allowed: StrictBool | None = None
    __properties = [
        "id",
        "name",
        "legal_name",
        ...
        _obj = LocationAnyOf.parse_obj(
            {
                ...
                "address": LocationAnyOfAddress.from_dict(obj.get("address"))
