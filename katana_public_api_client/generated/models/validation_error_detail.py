...
class ValidationErrorDetail(BaseModel):
    """
    Individual validation error detail  # noqa: E501
    """
    path: StrictStr = Field(default=..., description="JSON path to the field with the error")
    code: StrictStr = Field(default=..., description="Validation error code")
    message: Optional[StrictStr] = Field(default=None, description="Human-readable validation error message")
    info: Optional[Dict[str, Any]] = Field(default=None, description="Additional validation context")
    __properties = ["path", "code", "message", "info"]
