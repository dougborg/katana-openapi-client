...
if TYPE_CHECKING:
    ...
    from ..models.material_supplier import MaterialSupplier
    from ..models.material_variants_item import MaterialVariantsItem
...
class Material:
    ...
    Attributes:
        ...
        variants (Union[Unset, list['MaterialVariantsItem']]):
        configs (Union[Unset, list['MaterialConfigsItem']]):
        custom_field_collection_id (Union[Unset, int]):
        created_at (Union[Unset, datetime.datetime]):
        updated_at (Union[Unset, datetime.datetime]):
        archived_at (Union[None, Unset, datetime.datetime]):
        supplier (Union[Unset, MaterialSupplier]):
    """
    ...
    variants: Union[Unset, list["MaterialVariantsItem"]] = UNSET
    configs: Union[Unset, list["MaterialConfigsItem"]] = UNSET
    custom_field_collection_id: Union[Unset, int] = UNSET
    created_at: Union[Unset, datetime.datetime] = UNSET
    updated_at: Union[Unset, datetime.datetime] = UNSET
    archived_at: Union[None, Unset, datetime.datetime] = UNSET
    supplier: Union[Unset, "MaterialSupplier"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for variants_item_data in _variants or []:
            variants_item = MaterialVariantsItem.from_dict(variants_item_data)
        ...
        if isinstance(_supplier, Unset):
            ...
            supplier = MaterialSupplier.from_dict(_supplier)
