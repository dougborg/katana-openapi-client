...
class Material(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "archived_at", "id", "name", "uom", "category_name", "default_supplier_id", "additional_info", "batch_tracked", "is_sellable", "type", "purchase_uom", "purchase_uom_conversion_rate", "variants", "configs", "custom_field_collection_id", "supplier"]
