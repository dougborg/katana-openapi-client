...
class ManufacturingOrderListResponse(BaseModel):
    ...
    data: Optional[conlist(ManufacturingOrder)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderListResponse:
        """Create an instance of ManufacturingOrderListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderListResponse:
        """Create an instance of ManufacturingOrderListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderListResponse.parse_obj(obj)

        _obj = ManufacturingOrderListResponse.parse_obj(
            {
                "data": [
                    ManufacturingOrder.from_dict(_item) for _item in obj.get("data")
                ]
