...
class OperatorListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(Operator)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OperatorListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OperatorListResponse:
        """Create an instance of OperatorListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OperatorListResponse.parse_obj(obj)

        _obj = OperatorListResponse.parse_obj({
            "data": [Operator.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
