...
class SerialNumber(BaseModel):
    ...
    __properties = ["id", "transaction_id", "serial_number", "resource_type", "resource_id", "transaction_date"]
    ...
    def resource_type_validate_enum(cls, value):
        ...
        if value not in ('ManufacturingOrder', 'Production', 'StockAdjustmentRow', 'StockTransferRow', 'PurchaseOrderRow', 'SalesOrderRow',):
            raise ValueError("must be one of enum values ('ManufacturingOrder', 'Production', 'StockAdjustmentRow', 'StockTransferRow', 'PurchaseOrderRow', 'SalesOrderRow')")
        return value
