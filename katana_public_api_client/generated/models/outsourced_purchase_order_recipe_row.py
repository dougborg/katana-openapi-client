...
class OutsourcedPurchaseOrderRecipeRow(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "purchase_order_id", "purchase_order_row_id", "ingredient_variant_id", "planned_quantity_per_unit", "ingredient_availability", "ingredient_expected_date", "notes", "batch_transactions", "cost"]
    ...
    def ingredient_availability_validate_enum(cls, value):
        ...
        if value not in ('PROCESSED', 'IN_STOCK', 'NOT_AVAILABLE', 'EXPECTED', 'NOT_APPLICABLE',):
            raise ValueError("must be one of enum values ('PROCESSED', 'IN_STOCK', 'NOT_AVAILABLE', 'EXPECTED', 'NOT_APPLICABLE')")
        return value
