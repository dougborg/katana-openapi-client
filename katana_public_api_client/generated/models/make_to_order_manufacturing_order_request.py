...
class MakeToOrderManufacturingOrderRequest(BaseModel):
    """
    MakeToOrderManufacturingOrderRequest
    """
    sales_order_row_id: Union[StrictFloat, StrictInt] = Field(...)
    create_subassemblies: Optional[StrictBool] = False
    __properties = ["sales_order_row_id", "create_subassemblies"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MakeToOrderManufacturingOrderRequest:
        """Create an instance of MakeToOrderManufacturingOrderRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MakeToOrderManufacturingOrderRequest:
        """Create an instance of MakeToOrderManufacturingOrderRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MakeToOrderManufacturingOrderRequest.parse_obj(obj)

        _obj = MakeToOrderManufacturingOrderRequest.parse_obj({
            "sales_order_row_id": obj.get("sales_order_row_id"),
            "create_subassemblies": obj.get("create_subassemblies") if obj.get("create_subassemblies") is not None else False
        })
        return _obj
