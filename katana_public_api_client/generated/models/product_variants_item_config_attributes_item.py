...
T = TypeVar("T", bound="ProductVariantsItemConfigAttributesItem")


@_attrs_define
class ProductVariantsItemConfigAttributesItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        product_variants_item_config_attributes_item = cls(
            config_name=config_name,
            config_value=config_value,
        )

        product_variants_item_config_attributes_item.additional_properties = d
        return product_variants_item_config_attributes_item
