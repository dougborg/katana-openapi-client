...
class VariantResponse(BaseModel):
    ...
    product_or_material: Optional[VariantResponseAllOfProductOrMaterial] = None
    __properties = ["created_at", "updated_at", "deleted_at", "id", "sku", "sales_price", "purchase_price", "product_id", "material_id", "type", "internal_barcode", "registered_barcode", "supplier_item_codes", "lead_time", "minimum_order_quantity", "config_attributes", "custom_fields", "product_or_material"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in ('product', 'material', 'service',):
            raise ValueError("must be one of enum values ('product', 'material', 'service')")
        return value
    ...
    def from_dict(cls, obj: dict) -> VariantResponse:
        ...
        _obj = VariantResponse.parse_obj({
            ...
            "product_or_material": VariantResponseAllOfProductOrMaterial.from_dict(obj.get("product_or_material")) if obj.get("product_or_material") is not None else None
        })
        return _obj
