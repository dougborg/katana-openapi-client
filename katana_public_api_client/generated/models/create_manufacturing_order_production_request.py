...
class CreateManufacturingOrderProductionRequest(BaseModel):
    """
    ...
    operations: Optional[conlist(ManufacturingOrderOperationRow)] = None
    __properties = ["manufacturing_order_id", "quantity", "production_date", "ingredients", "operations"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateManufacturingOrderProductionRequest:
        """Create an instance of CreateManufacturingOrderProductionRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateManufacturingOrderProductionRequest:
        """Create an instance of CreateManufacturingOrderProductionRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateManufacturingOrderProductionRequest.parse_obj(obj)

        _obj = CreateManufacturingOrderProductionRequest.parse_obj({
            ...
            "operations": [ManufacturingOrderOperationRow.from_dict(_item) for _item in obj.get("operations")] if obj.get("operations") is not None else None
        })
        return _obj
