...
class CreateSalesOrderShippingFeeRequest(BaseModel):
    ...
    sales_order_id: StrictInt = Field(
        default=..., description="ID of the sales order to add shipping fee to"
    )
    amount: Union[StrictFloat, StrictInt] = Field(
        default=..., description="Shipping fee amount"
    )
    description: Optional[StrictStr] = Field(
        default=None, description="Description of the shipping fee"
    )
    tax_rate_id: Optional[StrictInt] = Field(
        default=None, description="ID of the tax rate to apply to the shipping fee"
    )
