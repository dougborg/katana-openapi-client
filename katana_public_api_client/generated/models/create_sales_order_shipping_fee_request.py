...
class CreateSalesOrderShippingFeeRequest(BaseModel):
    """
    CreateSalesOrderShippingFeeRequest
    """
    sales_order_id: StrictInt = Field(default=..., description="ID of the sales order to add shipping fee to")
    amount: Union[StrictFloat, StrictInt] = Field(default=..., description="Shipping fee amount")
    description: Optional[StrictStr] = Field(default=None, description="Description of the shipping fee")
    tax_rate_id: Optional[StrictInt] = Field(default=None, description="ID of the tax rate to apply to the shipping fee")
    __properties = ["sales_order_id", "amount", "description", "tax_rate_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateSalesOrderShippingFeeRequest:
        """Create an instance of CreateSalesOrderShippingFeeRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateSalesOrderShippingFeeRequest:
        """Create an instance of CreateSalesOrderShippingFeeRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateSalesOrderShippingFeeRequest.parse_obj(obj)

        _obj = CreateSalesOrderShippingFeeRequest.parse_obj({
