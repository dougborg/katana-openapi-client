...
class CreateCustomerAddressRequest(BaseModel):
    ...
    __properties = ["customer_id", "entity_type", "first_name", "last_name", "company", "phone", "line_1", "line_2", "city", "state", "zip", "country", "is_default"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateCustomerAddressRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateCustomerAddressRequest:
        """Create an instance of CreateCustomerAddressRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateCustomerAddressRequest.parse_obj(obj)

        _obj = CreateCustomerAddressRequest.parse_obj({
