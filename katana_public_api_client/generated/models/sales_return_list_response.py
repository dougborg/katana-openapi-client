...
class SalesReturnListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(SalesReturn)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SalesReturnListResponse:
        """Create an instance of SalesReturnListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SalesReturnListResponse:
        """Create an instance of SalesReturnListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SalesReturnListResponse.parse_obj(obj)

        _obj = SalesReturnListResponse.parse_obj({
            "data": [SalesReturn.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
