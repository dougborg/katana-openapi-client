...
class UnlinkVariantBinLocationRequest(BaseModel):
    """
    ...
    __properties = ["location_id", "variant_id"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UnlinkVariantBinLocationRequest:
        """Create an instance of UnlinkVariantBinLocationRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UnlinkVariantBinLocationRequest:
        """Create an instance of UnlinkVariantBinLocationRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UnlinkVariantBinLocationRequest.parse_obj(obj)

        _obj = UnlinkVariantBinLocationRequest.parse_obj(
            {"location_id": obj.get("location_id"), "variant_id": obj.get("variant_id")}
        )
        return _obj
