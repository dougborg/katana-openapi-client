...
class WebhookLogsExport(BaseModel):
    """
    WebhookLogsExport
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WebhookLogsExport:
        """Create an instance of WebhookLogsExport from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WebhookLogsExport:
        """Create an instance of WebhookLogsExport from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WebhookLogsExport.parse_obj(obj)

        _obj = WebhookLogsExport.parse_obj({"url": obj.get("url")})
        return _obj
