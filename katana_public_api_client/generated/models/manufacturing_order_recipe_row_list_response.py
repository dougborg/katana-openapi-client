...
class ManufacturingOrderRecipeRowListResponse(BaseModel):
    """
    ManufacturingOrderRecipeRowListResponse
    """
    data: Optional[conlist(ManufacturingOrderRecipeRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ManufacturingOrderRecipeRowListResponse:
        """Create an instance of ManufacturingOrderRecipeRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ManufacturingOrderRecipeRowListResponse:
        """Create an instance of ManufacturingOrderRecipeRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ManufacturingOrderRecipeRowListResponse.parse_obj(obj)

        _obj = ManufacturingOrderRecipeRowListResponse.parse_obj({
            "data": [ManufacturingOrderRecipeRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
