...
class InventoryMovementListResponse(BaseModel):
    """
    A list of inventory movement records.  # noqa: E501
    """

    data: conlist(InventoryMovement) = Field(...)
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryMovementListResponse:
        """Create an instance of InventoryMovementListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryMovementListResponse:
        """Create an instance of InventoryMovementListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryMovementListResponse.parse_obj(obj)

        _obj = InventoryMovementListResponse.parse_obj(
            {
                "data": [
                    InventoryMovement.from_dict(_item) for _item in obj.get("data")
                ]
