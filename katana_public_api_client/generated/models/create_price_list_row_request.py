...
class CreatePriceListRowRequest(BaseModel):
    """
    CreatePriceListRowRequest
    """
    price_list_id: StrictInt = Field(default=..., description="ID of the price list")
    variant_id: StrictInt = Field(default=..., description="ID of the variant to set price for")
    price: Union[StrictFloat, StrictInt] = Field(default=..., description="Price for the variant")
    currency: Optional[StrictStr] = Field(default=None, description="Currency code (e.g., USD, EUR)")
    __properties = ["price_list_id", "variant_id", "price", "currency"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreatePriceListRowRequest:
        """Create an instance of CreatePriceListRowRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreatePriceListRowRequest:
        """Create an instance of CreatePriceListRowRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreatePriceListRowRequest.parse_obj(obj)

        _obj = CreatePriceListRowRequest.parse_obj({
