...
class VariantDefaultStorageBinLink(BaseModel):
    """
    VariantDefaultStorageBinLink
    """

    location_id: Optional[conint(strict=True, le=2147483647)] = None
    variant_id: conint(strict=True, le=2147483647) = Field(...)
    bin_name: constr(strict=True, max_length=40, min_length=0) = Field(...)
    __properties = ["location_id", "variant_id", "bin_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VariantDefaultStorageBinLink:
        """Create an instance of VariantDefaultStorageBinLink from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VariantDefaultStorageBinLink:
        """Create an instance of VariantDefaultStorageBinLink from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VariantDefaultStorageBinLink.parse_obj(obj)

        _obj = VariantDefaultStorageBinLink.parse_obj(
            {
