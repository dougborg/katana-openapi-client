...
class StocktakeRowListResponse(BaseModel):
    """
    StocktakeRowListResponse
    """
    data: Optional[conlist(StocktakeRow)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> StocktakeRowListResponse:
        """Create an instance of StocktakeRowListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> StocktakeRowListResponse:
        """Create an instance of StocktakeRowListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return StocktakeRowListResponse.parse_obj(obj)

        _obj = StocktakeRowListResponse.parse_obj({
            "data": [StocktakeRow.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
