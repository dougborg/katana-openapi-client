...
class CreateProductRequestConfigsInner(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateProductRequestConfigsInner:
        """Create an instance of CreateProductRequestConfigsInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateProductRequestConfigsInner:
        """Create an instance of CreateProductRequestConfigsInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateProductRequestConfigsInner.parse_obj(obj)

        _obj = CreateProductRequestConfigsInner.parse_obj(
