...
class ServiceRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServiceRequest:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServiceRequest:
        """Create an instance of ServiceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServiceRequest.parse_obj(obj)

        _obj = ServiceRequest.parse_obj(
            {
                "data": ServiceRequestData.from_dict(obj.get("data"))
