...
class StocktakeRow(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "id", "stocktake_id", "variant_id", "batch_id", "system_quantity", "actual_quantity", "variance_quantity", "notes"]
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if self.variance_quantity is None and "variance_quantity" in self.__fields_set__:
