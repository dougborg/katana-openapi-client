...
class SerialNumberStock(BaseModel):
    """
    SerialNumberStock
    """
    ...
    __properties = ["created_at", "updated_at", "id", "variant_id", "location_id", "serial_number", "status"]

    @validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('IN_STOCK', 'SOLD', 'TRANSFERRED',):
            raise ValueError("must be one of enum values ('IN_STOCK', 'SOLD', 'TRANSFERRED')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SerialNumberStock:
        """Create an instance of SerialNumberStock from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SerialNumberStock:
        """Create an instance of SerialNumberStock from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SerialNumberStock.parse_obj(obj)

        _obj = SerialNumberStock.parse_obj({
