...
class CreateVariantRequestConfigAttributesInner(BaseModel):
    """
    CreateVariantRequestConfigAttributesInner
    """

    config_name: StrictStr = Field(...)
    config_value: StrictStr = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateVariantRequestConfigAttributesInner:
        """Create an instance of CreateVariantRequestConfigAttributesInner from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateVariantRequestConfigAttributesInner:
        """Create an instance of CreateVariantRequestConfigAttributesInner from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateVariantRequestConfigAttributesInner.parse_obj(obj)

        _obj = CreateVariantRequestConfigAttributesInner.parse_obj(
            {
