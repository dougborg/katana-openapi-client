...
class InventoryListResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InventoryListResponse:
        """Create an instance of InventoryListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InventoryListResponse:
        """Create an instance of InventoryListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InventoryListResponse.parse_obj(obj)

        _obj = InventoryListResponse.parse_obj({
            "data": [Inventory.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
