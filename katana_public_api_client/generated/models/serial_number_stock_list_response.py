...
class SerialNumberStockListResponse(BaseModel):
    """
    SerialNumberStockListResponse
    """

    data: Optional[conlist(SerialNumberStock)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SerialNumberStockListResponse:
        """Create an instance of SerialNumberStockListResponse from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SerialNumberStockListResponse:
        """Create an instance of SerialNumberStockListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SerialNumberStockListResponse.parse_obj(obj)

        _obj = SerialNumberStockListResponse.parse_obj(
            {
                "data": [
                    SerialNumberStock.from_dict(_item) for _item in obj.get("data")
                ]
