...
class PurchaseOrderListResponse(BaseModel):
    ...
    """
    data: Optional[conlist(PurchaseOrder)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PurchaseOrderListResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PurchaseOrderListResponse:
        """Create an instance of PurchaseOrderListResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PurchaseOrderListResponse.parse_obj(obj)

        _obj = PurchaseOrderListResponse.parse_obj({
            "data": [PurchaseOrder.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
