...
class Variant:
    ...
    Attributes:
        ...
        product_or_material_name (Union[Unset, str]): Display name combining the parent product/material name with
            variant attributes
        type_ (Union[Unset, str]): Type classification - either 'product' or 'material'
    ...
    custom_fields: Union[Unset, list["VariantCustomFieldsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for custom_fields_item_data in _custom_fields or []:
            custom_fields_item = VariantCustomFieldsItem.from_dict(custom_fields_item_data)
        ...
        for config_attributes_item_data in _config_attributes or []:
            config_attributes_item = VariantConfigAttributesItem.from_dict(config_attributes_item_data)
