...
class SalesReturn(BaseModel):
    ...
    refund_status: StrictStr | None = None
    sales_return_rows: conlist(SalesReturnRow) | None = None
    __properties = [
        "created_at",
        "updated_at",
        "deleted_at",
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('DRAFT', 'RETURNED', 'CANCELLED')"
            )
        return value
        ...
        _obj = SalesReturn.parse_obj(
            {
                ...
                "sales_return_rows": [
                    SalesReturnRow.from_dict(_item)
