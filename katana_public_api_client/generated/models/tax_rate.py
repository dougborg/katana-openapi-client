...
@_attrs_define
class TaxRate:
    """Tax rate configurations used throughout the system for sales and purchase transactions, defining percentage rates
    and default usage settings for automated tax calculations in financial operations
    """
