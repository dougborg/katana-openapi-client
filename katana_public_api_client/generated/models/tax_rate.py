...
class TaxRate(BaseModel):
    ...
    is_default_sales: Optional[StrictBool] = None
    is_default_purchases: Optional[StrictBool] = None
    display_name: Optional[StrictStr] = None
    __properties = ["created_at", "updated_at", "id", "name", "rate", "is_default_sales", "is_default_purchases", "display_name"]
    ...
    def from_dict(cls, obj: dict) -> TaxRate:
        ...
        _obj = TaxRate.parse_obj({
            ...
            "name": obj.get("name"),
            "rate": obj.get("rate"),
            "is_default_sales": obj.get("is_default_sales"),
            "is_default_purchases": obj.get("is_default_purchases"),
