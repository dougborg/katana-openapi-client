...
class ManufacturingOrder:
    ...
    creation to completion.
        ...
        Attributes:
            ...
            ingredient_availability (Union[Unset, str]): Status of material ingredient availability for production
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.sales_order_delivery_deadline, Unset):
            sales_order_delivery_deadline = self.sales_order_delivery_deadline.isoformat()
