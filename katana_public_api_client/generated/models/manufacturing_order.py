...
class ManufacturingOrder(BaseModel):
    ...
    __properties = ["created_at", "updated_at", "deleted_at", "id", "status", "order_no", "variant_id", "planned_quantity", "actual_quantity", "location_id", "order_created_date", "production_deadline_date", "additional_info", "is_linked_to_sales_order", "ingredient_availability", "total_cost", "total_actual_time", "total_planned_time", "sales_order_id", "sales_order_row_id", "sales_order_delivery_deadline", "material_cost", "subassemblies_cost", "operations_cost", "serial_numbers"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in ('NOT_STARTED', 'BLOCKED', 'IN_PROGRESS', 'DONE',):
            raise ValueError("must be one of enum values ('NOT_STARTED', 'BLOCKED', 'IN_PROGRESS', 'DONE')")
        return value
    ...
    def from_dict(cls, obj: dict) -> ManufacturingOrder:
        ...
        _obj = ManufacturingOrder.parse_obj({
            ...
            "sales_order_delivery_deadline": obj.get("sales_order_delivery_deadline"),
