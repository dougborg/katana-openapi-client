...
class UpdatePurchaseOrderAdditionalCostRowRequest(BaseModel):
    ...
    additional_cost_id: conint(strict=True, le=2147483647) | None = None
    tax_rate_id: conint(strict=True, le=2147483647) | None = None
    price: (
        confloat(le=100000000000000000, ge=0, strict=True)
        | conint(le=2147483647, ge=0, strict=True)
        | None
    ) = None
    distribution_method: StrictStr | None = None
    ...
    def distribution_method_validate_enum(cls, value):
        ...
        if value not in (
            ...
            raise ValueError(
                "must be one of enum values ('BY_VALUE', 'NON_DISTRIBUTED')"
            )
        return value
