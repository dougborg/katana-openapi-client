...
class DetailedErrorResponse(BaseModel):
    ...
    details: Optional[conlist(ValidationErrorDetail)] = Field(
        default=None, description="Detailed validation error information"
    )
        ...
        _obj = DetailedErrorResponse.parse_obj(
            {
                ...
                "code": obj.get("code"),
                "details": [
                    ValidationErrorDetail.from_dict(_item)
