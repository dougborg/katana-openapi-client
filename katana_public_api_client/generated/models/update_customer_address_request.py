...
class UpdateCustomerAddressRequest(BaseModel):
    ...
    __properties = ["entity_type", "first_name", "last_name", "company", "phone", "line_1", "line_2", "city", "state", "zip", "country", "is_default"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateCustomerAddressRequest:
        """Create an instance of UpdateCustomerAddressRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateCustomerAddressRequest:
        """Create an instance of UpdateCustomerAddressRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateCustomerAddressRequest.parse_obj(obj)

        _obj = UpdateCustomerAddressRequest.parse_obj({
