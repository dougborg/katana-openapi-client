...
class UpdatePurchaseOrderRowRequest(BaseModel):
    ...
    variant_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None, description="Updatable only when received_date is null"
    )
    tax_rate_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None, description="Updatable only when received_date is null"
    )
    group_id: Optional[conint(strict=True, le=2147483647)] = Field(
        default=None, description="Updatable only when received_date is null"
    )
    ...
    purchase_uom: Optional[constr(strict=True, max_length=7)] = Field(
        default=None, description="Updatable only when received_date is null"
    )
    received_date: Optional[StrictStr] = Field(
        default=None, description="Updatable only when already set"
    )
    arrival_date: Optional[StrictStr] = Field(
