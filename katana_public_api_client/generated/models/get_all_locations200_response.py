...
class GetAllLocations200Response(BaseModel):
    """
    GetAllLocations200Response
    """
    data: Optional[conlist(Location)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAllLocations200Response:
        """Create an instance of GetAllLocations200Response from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAllLocations200Response:
        """Create an instance of GetAllLocations200Response from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GetAllLocations200Response.parse_obj(obj)

        _obj = GetAllLocations200Response.parse_obj({
            "data": [Location.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
