...
class CreatePurchaseOrderRowRequest(BaseModel):
    ...
    group_id: conint(strict=True, le=2147483647) | None = None
    price_per_unit: confloat(le=100000000000000000, ge=0, strict=True) | conint(
    ...
    arrival_date: StrictStr | None = Field(
        default=None, description="Optional arrival date in ISO 8601 format."
    )
    __properties = [
        "purchase_order_id",
        "quantity",
