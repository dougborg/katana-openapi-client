...
class DeletableEntity(BaseModel):
    """
    Common fields for entities that can be deleted  # noqa: E501
    """
    created_at: Optional[datetime] = None
    updated_at: Optional[datetime] = None
    deleted_at: Optional[StrictStr] = Field(default=None, description="Nullable deletion timestamp")
    __properties = ["created_at", "updated_at", "deleted_at"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DeletableEntity:
        """Create an instance of DeletableEntity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DeletableEntity:
        """Create an instance of DeletableEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DeletableEntity.parse_obj(obj)

        _obj = DeletableEntity.parse_obj({
