...
class ArchivableEntity(BaseModel):
    """
    Common fields for entities that can be archived  # noqa: E501
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArchivableEntity:
        """Create an instance of ArchivableEntity from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArchivableEntity:
        """Create an instance of ArchivableEntity from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArchivableEntity.parse_obj(obj)

        _obj = ArchivableEntity.parse_obj(
            {
