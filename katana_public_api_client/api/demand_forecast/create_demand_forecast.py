...
from ...models.create_demand_forecast_request import CreateDemandForecastRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateDemandForecastRequest): Request payload for adding planned demand forecast
