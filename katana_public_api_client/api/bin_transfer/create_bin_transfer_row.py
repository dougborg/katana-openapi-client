...
from ...models.create_bin_transfer_row_request import CreateBinTransferRowRequest
...
def sync_detailed(
    *,
    ...
    Args:
        body (CreateBinTransferRowRequest): Request payload for adding a row to an existing bin
            transfer. Example: {'bin_transfer_id': 1, 'variant_id': 42, 'quantity': '3',
            'source_bin_location_id': 7, 'target_bin_location_id': 9}.
