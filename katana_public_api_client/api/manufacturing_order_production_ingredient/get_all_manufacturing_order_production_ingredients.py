...
from ...models.manufacturing_order_production_ingredient_list_response import (
...
def _get_kwargs(
    *,
    ...
    production_ids: list[int] | Unset = UNSET,
    ...
    json_production_ids: list[int] | Unset = UNSET
    if not isinstance(production_ids, Unset):
        json_production_ids = production_ids

    params["production_ids"] = json_production_ids
...
) -> ErrorResponse | ManufacturingOrderProductionIngredientListResponse | None:
    if response.status_code == 200:
        response_200 = ManufacturingOrderProductionIngredientListResponse.from_dict(
            response.json()
        )
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ErrorResponse | ManufacturingOrderProductionIngredientListResponse]:
    return Response(
    ...
    *,
    ...
    """List all manufacturing order production ingredients
     ...
     Returns a list of ingredient consumption records across manufacturing order productions.
      Each record ties a consumed ingredient variant to the production batch and recipe row it was used
    for.

    Args:
        ids (list[int] | Unset):
        manufacturing_order_ids (list[int] | Unset):
        production_ids (list[int] | Unset):
...
def sync(
    *,
    ...
    Returns:
        ErrorResponse | ManufacturingOrderProductionIngredientListResponse
    """
