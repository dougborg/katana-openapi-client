...
from ...models.update_price_list_row_request import UpdatePriceListRowRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Update a price list row
     ...
     Updates the specified price list row by setting the values of the parameters passed. Any parameters
    not provided
    ...
    Args:
        ...
        body (UpdatePriceListRowRequest): Request payload for updating an existing price list row
            Example: {'variant_id': 67890, 'adjustment_method': 'fixed', 'amount': 259.99}.
